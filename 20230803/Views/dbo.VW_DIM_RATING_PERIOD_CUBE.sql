...
GO
CREATE VIEW [dbo].[VW_DIM_RATING_PERIOD_CUBE]
WITH SCHEMABINDING
AS
SELECT  it.[ITEM_URN],
        it.[ITEM_BIZ_URN],
...
LEFT JOIN [dbo].[TB_DIM_RATING_PERIOD_PKEY_MAP] pk ON it.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN]
                                                      AND pk.[LATEST] = 1
...
SELECT  e.[ITEM_BIZ_URN] AS [ITEM_URN],
        ...
        -1 AS [FOLDER_URN],
        'Deleted Rating Period ' + CAST(e.[ITEM_BIZ_URN] AS NVARCHAR(10)) AS [NAME],
        '' AS [PKEY1],
        'This dimension does not exist in VIM anymore.' AS [DESCRIPTION],
        'Deleted Rating Period ' + CAST(e.[ITEM_BIZ_URN] AS NVARCHAR(10)) AS [INTERNAL_NAME],
        0 AS [MONDAY],
        0 AS [TUESDAY],
        0 AS [WEDNESDAY],
        0 AS [THURSDAY],
        ...
        0 AS [SATURDAY],
        0 AS [SUNDAY],
        '1900-01-01 00:00:00.000' AS [PERIOD_START],
        '1900-01-01 00:00:00.000' AS [PERIOD_END],
...
WHERE   e.[ITEM_TYPE_URN] = 83;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_RATING_PERIOD_CUBE]
	TO [portalapp_role]
GO
