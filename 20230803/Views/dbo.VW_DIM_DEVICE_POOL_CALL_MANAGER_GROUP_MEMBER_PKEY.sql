...
GO
CREATE   VIEW [dbo].[VW_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_PKEY]
WITH SCHEMABINDING
AS
    SELECT
        m.[MEMBER_URN],
    ...
    JOIN [dbo].[TB_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_PKEY_MAP] AS pk ON pk.[MEMBER_BIZ_URN] = m.[MEMBER_BIZ_URN];
GO
GRANT SELECT
	ON [dbo].[VW_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_PKEY]
	TO [portalapp_role]
GO
