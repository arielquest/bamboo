...
GO
CREATE VIEW [dbo].[VW_FCT_VOICE_CDR_DETAIL_CUBE]
AS
SELECT  [PARTITION_URN],
        ...
        CAST([EXTERNAL_XFER_OUT] AS BIGINT) AS [External Xfer Out],
...
FROM    [dbo].[VW_FCT_VOICE_CDR_DETAIL] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_VOICE_CDR_DETAIL_CUBE]
	TO [portalapp_role]
GO
