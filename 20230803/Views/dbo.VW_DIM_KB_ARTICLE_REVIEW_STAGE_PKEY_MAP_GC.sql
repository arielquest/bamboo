...
GO
CREATE   VIEW [dbo].[VW_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('a25e34b9-79e9-4601-9fd8-51a638940e4c' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
