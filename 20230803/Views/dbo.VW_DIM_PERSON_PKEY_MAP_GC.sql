...
GO
CREATE   VIEW [dbo].[VW_DIM_PERSON_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('00003150-1000-0000-0000-000000000010' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
        ...
        pkey.[LOGIN_NAME],
        pkey.[PASS_PHRASE],
        pkey.[PASS_PHRASE_SHA],
        pkey.[LOGIN_ENABLED],
        pkey.[SSO_ENABLED],
        pkey.[VERIFICATION_STATUS],
        pkey.[HOME_CLUSTER],
        pkey.[ENABLE_USER],
        pkey.[MEETING_INFORMATION],
        pkey.[UC_SERVICE_PROFILE_BIZ_URN],
    ...
    FROM [dbo].[TS_DIM_PERSON_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_PERSON_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_PERSON_PKEY_MAP_GC]
	TO [portalapp_role]
GO
