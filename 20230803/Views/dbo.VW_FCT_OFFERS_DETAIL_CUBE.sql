...
GO
CREATE VIEW [dbo].[VW_FCT_OFFERS_DETAIL_CUBE]
AS
SELECT  [PARTITION_URN],
        ...
        CAST([VISITS_CNTR] AS BIGINT) AS [Page Visits],
        CAST([PRESENTED_CNTR] AS BIGINT) AS [Offers Presented Total],
        CAST([ACCEPTED_CNTR] AS BIGINT) AS [Offers Accepted Total],
        CAST([ACCEPTED_CLICK_CNTR] AS BIGINT) AS [Offers Accept Clicked Total],
        CAST([REJECTED_CNTR] AS BIGINT) AS [Offers Rejected Total],
        CAST([IGNORED_CNTR] AS BIGINT) AS [Offers Ignored Total],
        CAST([CONVERTED_CNTR] AS BIGINT) AS [Offers Converted Total],
        CAST([ELIGIBLE_CNTR] AS BIGINT) AS [Visitor Eligible Total],
        CAST([ENGAGED_CNTR] AS BIGINT) AS [Visitor Engaged Total],
        CAST([FIRST_RESPONSE_CNTR] AS BIGINT) AS [Visitor First Response Total],
        [PARTITION_ID],
        [Row Count],
...
FROM    [dbo].[VW_FCT_OFFERS_DETAIL] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_OFFERS_DETAIL_CUBE]
	TO [portalapp_role]
GO
