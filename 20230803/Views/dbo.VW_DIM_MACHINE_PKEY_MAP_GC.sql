...
GO
CREATE   VIEW [dbo].[VW_DIM_MACHINE_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('dd962dbf-c1fb-4637-985d-81c710d19e15' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_MACHINE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_MACHINE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_MACHINE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
