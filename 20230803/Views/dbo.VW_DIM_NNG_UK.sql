...
--
-------------------------------------------------------------------------------
CREATE VIEW [dbo].[VW_DIM_NNG_UK]
--WITH ENCRYPTION
AS
SELECT  g.[NNG_URN] AS [NNG_URN],
        a.[MEMBER] AS [Continent],
        b.[MEMBER] AS [Country],
        c.[MEMBER] AS [TV Region],
        d.[MEMBER] AS [County Council],
        e.[MEMBER] AS [Unitary Authority],
        f.[MEMBER] AS [Town],
...
JOIN    [dbo].[TB_DIM_NNG] c ON b.[NNG_URN] = c.[PARENT_URN]
JOIN    [dbo].[TB_DIM_NNG] d ON c.[NNG_URN] = d.[PARENT_URN]
...
WHERE   f.[SKIP_LEVEL] = 0
        AND b.[NNG_URN] = 3045 -- Corresponds to Country => United Kingdom
UNION
...
SELECT  [NNG_URN] AS [NNG_URN],
        ...
        [MEMBER] AS [Country],
        [MEMBER] AS [TV Region],
        [MEMBER] AS [County Council],
        [MEMBER] AS [Unitary Authority],
        [MEMBER] AS [Town],
        [MEMBER] AS [Area Code],
