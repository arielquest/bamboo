...
GO
CREATE   VIEW [dbo].[VW_DIM_DEVICE_PROFILE_PKEY_MAP_GC]
AS
   SELECT 
    ...
    FROM [dbo].[TS_DIM_DEVICE_PROFILE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_DEVICE_PROFILE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_DEVICE_PROFILE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
