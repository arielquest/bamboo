...
GO
CREATE   VIEW [dbo].[VW_DIM_GHE_QUESTION_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('95009762-fc8e-4303-8096-86fb24ec0cb3' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_GHE_QUESTION_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_GHE_QUESTION_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_GHE_QUESTION_PKEY_MAP_GC]
	TO [portalapp_role]
GO
