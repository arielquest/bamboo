...
GO
CREATE   VIEW [dbo].[VW_DIM_COBROWSE_PAGE_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('516ff4e5-cbb6-4745-ad0f-a926ee0ad23e' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_COBROWSE_PAGE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_COBROWSE_PAGE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_COBROWSE_PAGE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
