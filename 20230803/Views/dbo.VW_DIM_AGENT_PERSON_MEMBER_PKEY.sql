...
GO
CREATE   VIEW [dbo].[VW_DIM_AGENT_PERSON_MEMBER_PKEY]
WITH SCHEMABINDING
AS
    SELECT
        m.[MEMBER_URN],
        m.[MEMBER_BIZ_URN],
        CAST('00000016-1000-0000-0000-0000000000c0' AS UNIQUEIDENTIFIER) AS [MEMBER_TYPE_ID],
    ...
    JOIN [dbo].[TB_DIM_AGENT_PERSON_MEMBER_PKEY_MAP] AS pk ON pk.[MEMBER_BIZ_URN] = m.[MEMBER_BIZ_URN];
GO
GRANT SELECT
	ON [dbo].[VW_DIM_AGENT_PERSON_MEMBER_PKEY]
	TO [portalapp_role]
GO
