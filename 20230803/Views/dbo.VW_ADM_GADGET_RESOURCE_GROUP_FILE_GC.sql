...
GO
CREATE VIEW [dbo].[VW_ADM_GADGET_RESOURCE_GROUP_FILE_GC]
WITH SCHEMABINDING
AS
    ...
    LEFT JOIN [dbo].[TB_ADM_GADGET_RESOURCE_GROUP_FILE] [g] ON [g].[ID] = [datagc].[GUID_KEY]
    WHERE   [tablegc].[TABLE_NAME] = 'TB_ADM_GADGET_RESOURCE_GROUP_FILE';
GO
GRANT SELECT
	ON [dbo].[VW_ADM_GADGET_RESOURCE_GROUP_FILE_GC]
	TO [portalapp_role]
GO
