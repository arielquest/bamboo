...
GO
CREATE   VIEW [dbo].[VW_DIM_QUEUE_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('61a20821-ae86-4d50-b6a9-502d89453907' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
        ...
        pkey.[DESCRIPTION],
        pkey.[STATE],
        pkey.[EMAIL_ROUTING_TYPE],
        pkey.[CHAT_ROUTING_TYPE],
        pkey.[SOCIAL_ROUTING_TYPE],
    ...
    FROM [dbo].[TS_DIM_QUEUE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_QUEUE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_QUEUE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
