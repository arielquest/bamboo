...
GO
CREATE   VIEW [dbo].[VW_DIM_IP_ENDPOINT_BUTTON_TEMPLATE_PKEY]
WITH SCHEMABINDING
AS
    SELECT di.[ITEM_URN],
           di.[ITEM_BIZ_URN],
           ...
           fl.[FOLDER_URN],
           di.[OWNER_ID],
           CAST('00011000-1000-0000-0000-000000000010' AS UNIQUEIDENTIFIER) AS [ITEM_TYPE_ID],
           di.[ITEM_SUBTYPE_ID],
           di.[NAME],    
           ...
           pk.[INTERNAL_NAME],
           di.[MODEL_CODE_BIZ_URN],
           di.[PROTOCOL_CODE_BIZ_URN],
           pk.[LINE_COUNT],
           di.[TIME_ZONE_URN],
           di.[TENANT_BIZ_URN],
    ...
    FROM [dbo].[TB_DIM_IP_ENDPOINT_BUTTON_TEMPLATE] di
    JOIN [dbo].[TB_DIM_IP_ENDPOINT_BUTTON_TEMPLATE_PKEY_MAP] pk ON di.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN]
    JOIN [dbo].[TB_SEC_FOLDER] fl ON fl.[FOLDER_ID] = di.[FOLDER_ID];
GO
GRANT SELECT
	ON [dbo].[VW_DIM_IP_ENDPOINT_BUTTON_TEMPLATE_PKEY]
	TO [portalapp_role]
GO
