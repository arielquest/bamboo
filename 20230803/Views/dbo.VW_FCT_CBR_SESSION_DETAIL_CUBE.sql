...
GO
CREATE VIEW [dbo].[VW_FCT_CBR_SESSION_DETAIL_CUBE]
AS
SELECT [PARTITION_URN],
       ...
       [KB_ARTICLE_TYPE_URN],
       [ARTICLE_TYPE_URN],
       [KB_SOLUTION_FOLDER_URN],
       [KB_SOLUTION_OWNER_URN],
       [KB_START_FOLDER_URN],
       [KB_START_OWNER_URN],
       ...
       CAST([SOLUTION_ACCEPTED_CNTR] AS BIGINT) AS [Solution Accepted Counter],
       CAST([SOLUTION_REJECTED_CNTR] AS BIGINT) AS [Solution Rejected Counter],
...
FROM [dbo].[VW_FCT_CBR_SESSION_DETAIL] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_CBR_SESSION_DETAIL_CUBE]
	TO [portalapp_role]
GO
