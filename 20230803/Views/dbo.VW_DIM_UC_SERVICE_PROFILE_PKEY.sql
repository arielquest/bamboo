...
GO
CREATE   VIEW [dbo].[VW_DIM_UC_SERVICE_PROFILE_PKEY]
WITH SCHEMABINDING
AS
    SELECT di.[ITEM_URN],
           di.[ITEM_BIZ_URN],
    ...
    FROM [dbo].[TB_DIM_UC_SERVICE_PROFILE] di
    JOIN [dbo].[TB_DIM_UC_SERVICE_PROFILE_PKEY_MAP] pk ON di.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN]
