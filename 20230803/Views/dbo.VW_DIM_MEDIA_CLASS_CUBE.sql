...
GO
CREATE VIEW [dbo].[VW_DIM_MEDIA_CLASS_CUBE]
WITH SCHEMABINDING
AS
SELECT  it.[ITEM_URN],
        it.[ITEM_BIZ_URN],
        CAST('00009550-1000-0000-0000-000000000010' AS UNIQUEIDENTIFIER) AS [ITEM_TYPE_ID],
        it.[ITEM_SUBTYPE_ID],
        it.[OWNER_ID],
        it.[FOLDER_ID],
        ...
        pk.[TASK_LIFE],
        pk.[TASK_START_TIMEOUT],
        pk.[MAX_TASK_DURATION],
        it.[EFFECTIVE_FROM],
        it.[EFFECTIVE_TO],
        ...
        it.[LATEST],
        it.[CHANGE_STAMP]
FROM    [dbo].[TB_DIM_MEDIA_CLASS] it
LEFT JOIN [dbo].[TB_DIM_MEDIA_CLASS_PKEY_MAP] pk ON it.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN] AND pk.[LATEST] = 1
...
SELECT  e.[ITEM_BIZ_URN] AS [ITEM_URN],
        ...
        -1 AS [FOLDER_URN],
        'Deleted Media Class ' + CAST(e.[ITEM_BIZ_URN] AS NVARCHAR(10)) AS [NAME],
        'Deleted Media Class ' + CAST(e.[ITEM_BIZ_URN] AS NVARCHAR(10)) AS [INTERNAL_NAME],       
        'This dimension does not exist anymore.' AS [DESCRIPTION],
         '' AS [PKEY1],
        0 AS [TASK_LIFE],
        0 AS [TASK_START_TIMEOUT],
        0 AS [MAX_TASK_DURATION],
...
WHERE   e.[ITEM_TYPE_URN] = 67;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_MEDIA_CLASS_CUBE]
	TO [portalapp_role]
GO
