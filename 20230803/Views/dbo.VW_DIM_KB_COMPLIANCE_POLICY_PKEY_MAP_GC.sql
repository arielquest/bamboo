...
GO
CREATE   VIEW [dbo].[VW_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('555644c0-afa2-498d-b7fa-038a00f821f0' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP_GC]
	TO [portalapp_role]
GO
