...
GO
CREATE VIEW [dbo].[VW_SEC_USER_GROUP_MEMBER_GC]
WITH SCHEMABINDING
AS
SELECT  datagc.[GUID_KEY] AS [RESOURCE_ID],
        ...
        CAST('EEE2E0E2-C672-4f3c-A84F-59800D8565E4' AS UNIQUEIDENTIFIER) AS CHILD_RESOURCE_TYPE_ID, -- IT_USER
...
WHERE   tablegc.TABLE_NAME = 'TB_SEC_USER_GROUP_MEMBER';
GO
GRANT SELECT
	ON [dbo].[VW_SEC_USER_GROUP_MEMBER_GC]
	TO [portalapp_role]
GO
