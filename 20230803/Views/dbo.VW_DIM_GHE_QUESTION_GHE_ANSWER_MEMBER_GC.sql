...
GO
CREATE   VIEW [dbo].[VW_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_GC]
AS
    SELECT 
        ...
        CAST('95009762-fc8e-4303-8096-86fb24ec0cb3' AS UNIQUEIDENTIFIER) AS [PARENT_RESOURCE_TYPE_ID],
        CAST('b1dc6b14-72cf-4c51-876e-1da1e1f63b74' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
    ...
    FROM [dbo].[TS_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_GC] datagc 
    
    LEFT JOIN [dbo].[TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER] member
    ON member.MEMBER_URN = datagc.MEMBER_URN

    WHERE datagc.[MEMBER_URN] > 0;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_GC]
	TO [portalapp_role]
GO
