...
GO
CREATE VIEW [dbo].[VW_FCT_IVR_VXML_ELEMENT_CUBE]
AS
SELECT  [PARTITION_URN],
        ...
        -- Dimensions
        [ELEMENT_TYPE_CODE_URN],
        [RESULT_CODE_URN],
        [DIALED_NUMBER_URN],
        [IVR_SCRIPT_URN],
        [SOURCE_IVR_SCRIPT_URN],
        [IVR_SCRIPT_NODE_URN],
        [IVR_SCRIPT_NODE_EXIT_STATE_URN],
        [CLUSTER_RESOURCE_URN],
            
            
            -- Measures
        CAST([TOTAL_INTERACTIONS] AS BIGINT) AS [TOTAL_INTERACTIONS],
...
FROM    [dbo].[VW_FCT_IVR_VXML_ELEMENT] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_IVR_VXML_ELEMENT_CUBE]
	TO [portalapp_role]
GO
