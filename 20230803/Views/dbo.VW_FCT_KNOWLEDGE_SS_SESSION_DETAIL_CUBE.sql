...
GO
CREATE VIEW [dbo].[VW_FCT_KNOWLEDGE_SS_SESSION_DETAIL_CUBE]
AS
SELECT [PARTITION_URN],
       ...
       [KB_TOPIC_URN],
       [KB_ARTICLE_URN],
       [KB_SEARCH_STRING_URN],
       [KB_ACCESS_TYPE] AS [KB_ACCESS_TYPE_URN],
       [KB_ARTICLE_ACCESS_METHOD] AS [KB_ARTICLE_ACCESS_METHOD_URN],
       [MANAGER_AGENT_URN],
       [KB_ARTICLE_TYPE_URN],
       [ARTICLE_TYPE_URN],
       [SESSION_ENTRY_TIME],
       ...
       CAST([ARTICLE_ACCESS_ACTIVITY_CNTR] AS BIGINT) AS [Article Access Activity Counter],
       ...
       CAST([ARTICLE_RATING] AS BIGINT) AS [Article Rating], 
       CAST([ARTICLE_USEFUL_CNTR] AS BIGINT) AS [Article Useful Counter],
       CAST([ESCALATED_CNTR] AS BIGINT) AS [Escalated Counter],
       CAST([ESCALATIONS_ATTEMPTED_CNTR] AS BIGINT) AS [Escalations Attempted Counter],
       CAST([ESCALATIONS_AVERTED_CNTR] AS BIGINT) AS [Escalations Averted Counter],
       CAST([SEARCH_RESULT_ARTICLE_COUNT] AS BIGINT) AS [Search Result Article Count],
       ...
       CAST([SUCCESSFUL_SESSION_CNTR] AS BIGINT) AS [Successful Session Counter],
...
FROM [dbo].[VW_FCT_KNOWLEDGE_SS_SESSION_DETAIL] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_KNOWLEDGE_SS_SESSION_DETAIL_CUBE]
	TO [portalapp_role]
GO
