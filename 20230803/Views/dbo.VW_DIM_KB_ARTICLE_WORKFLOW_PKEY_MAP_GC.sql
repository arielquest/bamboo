...
GO
CREATE   VIEW [dbo].[VW_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('140ae2b9-c3ba-42bb-8508-0240e45b95c1' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP_GC]
	TO [portalapp_role]
GO
