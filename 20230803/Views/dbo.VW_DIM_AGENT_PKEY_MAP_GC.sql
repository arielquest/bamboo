...
GO
CREATE   VIEW [dbo].[VW_DIM_AGENT_PKEY_MAP_GC]
AS
   SELECT 
        ...
        pkey.[SUPERVISOR],
        pkey.[AGENT_STATE_TRACE],
        pkey.[DOMAIN_NAME],
        pkey.[DOMAIN_LOGIN_NAME],
        pkey.[DOMAIN_USER_NAME],
        pkey.[DOMAIN_USER_GUID],
        pkey.[USER_DELETABLE],
        pkey.[USER_GROUP_ID],
        pkey.[ENABLED_ASSIST_SERVICE_TYPES],
    ...
    FROM [dbo].[TS_DIM_AGENT_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_AGENT_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_AGENT_PKEY_MAP_GC]
	TO [portalapp_role]
GO
