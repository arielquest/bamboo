...
GO
CREATE   VIEW [dbo].[VW_DIM_UC_SERVICE_PROFILE_PKEY_MAP_GC]
AS
   SELECT 
        ...
        CAST('c79483bb-ad3d-4135-83ce-bb3cf92bb765' AS UNIQUEIDENTIFIER) AS [CHILD_RESOURCE_TYPE_ID],
        pkey.[STATUS],
        pkey.[CHANGE_STAMP],
        pkey.[PKEY1],
        pkey.[PKEY2],
    ...
    FROM [dbo].[TS_DIM_UC_SERVICE_PROFILE_PKEY_MAP_GC] datagc
    
    LEFT JOIN [dbo].[TB_DIM_UC_SERVICE_PROFILE_PKEY_MAP] pkey
    ON pkey.PKEY_MAP_URN = datagc.PKEY_MAP_URN;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_UC_SERVICE_PROFILE_PKEY_MAP_GC]
	TO [portalapp_role]
GO
