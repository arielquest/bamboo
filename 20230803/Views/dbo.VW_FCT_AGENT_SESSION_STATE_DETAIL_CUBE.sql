...
GO
CREATE VIEW [dbo].[VW_FCT_AGENT_SESSION_STATE_DETAIL_CUBE]
AS
   SELECT   [PARTITION_URN],
            ...
            CAST([AVAILABLE_DURATION_CALLTRACK] AS BIGINT) AS [Available Duration Calltrack],
            CAST([AVAILABLE_DURATION_CALLTRACK_WORK] AS BIGINT) AS [Available Duration Calltrack Work],
            CAST([AVAILABLE_DURATION_CHAT] AS BIGINT) AS [Available Duration Chat],
            CAST([AVAILABLE_DURATION_CHAT_WORK] AS BIGINT) AS [Available Duration Chat Work],
            CAST([AVAILABLE_DURATION_EMAIL] AS BIGINT) AS [Available Duration Email],
            CAST([AVAILABLE_DURATION_EMAIL_WORK] AS BIGINT) AS [Available Duration Email Work],
            CAST([AVAILABLE_DURATION_SOCIAL] AS BIGINT) AS [Available Duration Social],
            CAST([AVAILABLE_DURATION_SOCIAL_WORK] AS BIGINT) AS [Available Duration Social Work],
            CAST([AVAILABLE_DURATION_TASKS] AS BIGINT) AS [Available Duration Tasks],
            CAST([AVAILABLE_DURATION_TASKS_WORK] AS BIGINT) AS [Available Duration Tasks Work],
            CAST([AVAILABLE_DURATION_VCHAT] AS BIGINT) AS [Available Duration VChat],
            CAST([AVAILABLE_DURATION_VCHAT_WORK] AS BIGINT) AS [Available Duration VChat Work],
            ...
            CAST([UNAVAILABLE_DURATION_CALLTRACK_WORK] AS BIGINT) AS [Unavailable Duration Calltrack Work],
            CAST([UNAVAILABLE_DURATION_CHAT] AS BIGINT) AS [Unavailable Duration Chat],
            CAST([UNAVAILABLE_DURATION_CHAT_WORK] AS BIGINT) AS [Unavailable Duration Chat Work],
            CAST([UNAVAILABLE_DURATION_EMAIL] AS BIGINT) AS [Unavailable Duration Email],
            CAST([UNAVAILABLE_DURATION_EMAIL_WORK] AS BIGINT) AS [Unavailable Duration Email Work],
            CAST([UNAVAILABLE_DURATION_SOCIAL] AS BIGINT) AS [Unavailable Duration Social],
            CAST([UNAVAILABLE_DURATION_SOCIAL_WORK] AS BIGINT) AS [Unavailable Duration Social Work],
            CAST([UNAVAILABLE_DURATION_TASKS] AS BIGINT) AS [Unavailable Duration Tasks],
            CAST([UNAVAILABLE_DURATION_TASKS_WORK] AS BIGINT) AS [Unavailable Duration Tasks Work],
            CAST([UNAVAILABLE_DURATION_VCHAT] AS BIGINT) AS [Unavailable Duration VChat],
            CAST([UNAVAILABLE_DURATION_VCHAT_WORK] AS BIGINT) AS [Unavailable Duration VChat Work],         
            CAST([UNAVAILABLE_DURATION_CHAT_OTHER] AS BIGINT) AS [Unavailable Duration Chat Other], 
            CAST([UNAVAILABLE_DURATION_VCHAT_OTHER] AS BIGINT) AS [Unavailable Duration VChat Other], 
            CAST([UNAVAILABLE_DURATION_EMAIL_OTHER] AS BIGINT) AS [Unavailable Duration Email Other], 
            CAST([UNAVAILABLE_DURATION_SOCIAL_OTHER] AS BIGINT) AS [Unavailable Duration Social Other], 
            CAST([UNAVAILABLE_DURATION_TASKS_OTHER] AS BIGINT) AS [Unavailable Duration Tasks Other], 
            CAST([UNAVAILABLE_DURATION_CALLTRACK_OTHER] AS BIGINT) AS [Unavailable Duration Calltrack Other],
    ...
    FROM [dbo].[VW_FCT_AGENT_SESSION_STATE_DETAIL] x
...
GO
GRANT SELECT
	ON [dbo].[VW_FCT_AGENT_SESSION_STATE_DETAIL_CUBE]
	TO [portalapp_role]
GO
