...
GO
CREATE VIEW [dbo].[VW_DIM_VECTOR_DIRECTORY_NUMBER_CUBE]
WITH SCHEMABINDING
AS
SELECT  it.[ITEM_URN],
        it.[ITEM_BIZ_URN],
        CAST('39c95ad6-8271-4494-9702-03066abcc02b' AS UNIQUEIDENTIFIER) AS [ITEM_TYPE_ID],
        it.[ITEM_SUBTYPE_ID],
        it.[OWNER_ID],
        it.[FOLDER_ID],
        ...
        it.[LATEST],
        it.[CHANGE_STAMP]
FROM    [dbo].[TB_DIM_VECTOR_DIRECTORY_NUMBER] it
LEFT JOIN [dbo].[TB_DIM_VECTOR_DIRECTORY_NUMBER_PKEY_MAP] pk ON it.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN]
                                                              AND pk.[LATEST] = 1
...
SELECT  e.[ITEM_BIZ_URN] AS [ITEM_URN],
        ...
        -1 AS [FOLDER_URN],
        'Deleted Vector Directory Number '
...
WHERE   e.[ITEM_TYPE_URN] = 104;
GO
GRANT SELECT
	ON [dbo].[VW_DIM_VECTOR_DIRECTORY_NUMBER_CUBE]
	TO [portalapp_role]
GO
