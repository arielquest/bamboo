...
GO
CREATE   VIEW [dbo].[VW_DIM_KB_ARTICLE_PKEY]
WITH SCHEMABINDING
AS
    SELECT di.[ITEM_URN],
           di.[ITEM_BIZ_URN],
           ...
           pk.[DESCRIPTION],
           pk.[KEYWORDS],
           di.[ARTICLE_CREATION_CULTURE_URN],
           di.[ARTICLE_COMMIT_STATE],
           di.[ARTICLE_PUBLISH_STATE],
           di.[ARTICLE_OWNER_AGENT_BIZ_URN],
           di.[ARTICLE_CREATED_BY_AGENT_BIZ_URN],
           di.[ARTICLE_LAST_MODIFIED_BY_AGENT_BIZ_URN],
           di.[ARTICLE_CREATION_DATE_TIME],
           di.[ARTICLE_LAST_MODIFIED_DATE_TIME],
           di.[ARTICLE_VERSION],
           di.[ARTICLE_AVAILABLE_FROM],
           di.[ARTICLE_EXPIRES_ON],
           di.[KB_FOLDER_BIZ_URN],
           pk.[ARTICLE_DISPLAY_ID],
           di.[TIME_ZONE_URN],
           di.[TENANT_BIZ_URN],
    ...
    FROM [dbo].[TB_DIM_KB_ARTICLE] di
    JOIN [dbo].[TB_DIM_KB_ARTICLE_PKEY_MAP] pk ON di.[ITEM_BIZ_URN] = pk.[ITEM_BIZ_URN]
    JOIN [dbo].[TB_SEC_FOLDER] fl ON fl.[FOLDER_ID] = di.[FOLDER_ID];
GO
GRANT SELECT
	ON [dbo].[VW_DIM_KB_ARTICLE_PKEY]
	TO [portalapp_role]
GO
