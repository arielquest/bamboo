...
GO
CREATE VIEW [dbo].[VW_FCT_IVR_CALL_CUBE]
AS
SELECT  [PARTITION_URN],
        ...
        [DIALED_NUMBER_URN],
        [CALL_TYPE_CODE_URN],
        [SUBSYSTEM_TYPE_CODE_URN],
        [CLUSTER_RESOURCE_URN],
            
            -- Measures
        CAST([DURATION] AS BIGINT) AS [DURATION],
        CAST([NUM_TIMEOUT] AS BIGINT) AS [NUM_TIMEOUT],
        CAST([NUM_ERROR] AS BIGINT) AS [NUM_ERROR],
        CAST([NUM_HOLD] AS BIGINT) AS [NUM_HOLD],
        CAST([NUM_APP_VISITED] AS BIGINT) AS [NUM_APP_VISITED],
        CAST([TOTAL_TRANSFER] AS BIGINT) AS [TOTAL_TRANSFER],
