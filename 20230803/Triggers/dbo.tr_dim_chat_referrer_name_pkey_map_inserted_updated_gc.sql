...
GO
CREATE TRIGGER [dbo].[tr_dim_chat_referrer_name_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CHAT_REFERRER_NAME_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_chatreferrernPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CHAT_REFERRER_NAME_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CHAT_REFERRER_NAME_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '0348a177-ea2f-4191-8597-cc02dacea8e2'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_chatreferrernPKEYTran;
            END;
            ELSE BEGIN 
