...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_workflow_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_WORKFLOW] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_WORKFLOW_GC dgc
