...
GO
CREATE TRIGGER [dbo].[tr_dim_ecc_payload_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ECC_PAYLOAD_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_eccpaylPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_ECC_PAYLOAD_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_ECC_PAYLOAD_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '10fb2472-bf84-4cf8-a8bb-cc7dc9147df7'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_eccpaylPKEYTran;
            END;
            ELSE BEGIN 
