...
GO
CREATE TRIGGER [dbo].[tr_dim_device_profile_directory_number_member_inserted_updated_gc] ON [dbo].[TB_DIM_DEVICE_PROFILE_DIRECTORY_NUMBER_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_deviceprofiledirectoryTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_DEVICE_PROFILE_DIRECTORY_NUMBER_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_DEVICE_PROFILE_DIRECTORY_NUMBER_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_deviceprofiledirectoryTran;
            END;
            ELSE BEGIN 
