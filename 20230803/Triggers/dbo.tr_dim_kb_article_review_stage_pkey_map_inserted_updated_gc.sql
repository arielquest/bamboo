...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_review_stage_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbarticlereviewstPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_REVIEW_STAGE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'a25e34b9-79e9-4601-9fd8-51a638940e4c'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbarticlereviewstPKEYTran;
            END;
            ELSE BEGIN 
