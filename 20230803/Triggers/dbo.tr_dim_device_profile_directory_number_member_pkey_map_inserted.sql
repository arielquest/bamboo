...
GO
CREATE TRIGGER [dbo].[tr_dim_device_profile_directory_number_member_pkey_map_inserted] ON [dbo].[TB_DIM_DEVICE_PROFILE_DIRECTORY_NUMBER_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
