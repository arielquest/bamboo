...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_channel_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_CHANNEL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_notifychanPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NOTIFY_CHANNEL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NOTIFY_CHANNEL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '10f7f60a-f120-49e5-9ea1-5adc5a66371f'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_notifychanPKEYTran;
            END;
            ELSE BEGIN 
