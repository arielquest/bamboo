...
GO
CREATE TRIGGER [dbo].[tr_dim_va_customer_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_CUSTOMER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vacustoPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_CUSTOMER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_CUSTOMER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'a5575cc4-ab5c-4af9-a650-88b746c48f46'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vacustoPKEYTran;
            END;
            ELSE BEGIN 
