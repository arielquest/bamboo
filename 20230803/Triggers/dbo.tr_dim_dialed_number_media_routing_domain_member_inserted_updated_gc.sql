...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_media_routing_domain_member_inserted_updated_gc] ON [dbo].[TB_DIM_DIALED_NUMBER_MEDIA_ROUTING_DOMAIN_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_dialednumbermediaroutiTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_DIALED_NUMBER_MEDIA_ROUTING_DOMAIN_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_DIALED_NUMBER_MEDIA_ROUTING_DOMAIN_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_dialednumbermediaroutiTran;
            END;
            ELSE BEGIN 
