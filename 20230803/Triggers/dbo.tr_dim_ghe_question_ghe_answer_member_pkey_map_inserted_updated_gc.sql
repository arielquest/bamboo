...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_question_ghe_answer_member_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ghequestiongheanswermPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.MEMBER_TYPE_ID = '645ac84a-d580-4c9c-ad36-3ec15a86e82c'
                AND map.STATUS IN ('S', 'P');
            END;

            IF @InitialTransactionCount = 0 
            BEGIN 
               COMMIT TRANSACTION TR_ghequestiongheanswermPKEYTran;
            END;
            ELSE BEGIN 
