...
GO
CREATE TRIGGER [dbo].[tr_dim_expanded_call_variable_ecc_payload_member_inserted_updated_gc] ON [dbo].[TB_DIM_EXPANDED_CALL_VARIABLE_ECC_PAYLOAD_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_expandedcallvariableecTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_EXPANDED_CALL_VARIABLE_ECC_PAYLOAD_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_EXPANDED_CALL_VARIABLE_ECC_PAYLOAD_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_expandedcallvariableecTran;
            END;
            ELSE BEGIN 
