...
GO
CREATE TRIGGER [dbo].[tr_adm_custom_attribute_deleted_gc] ON [dbo].[TB_ADM_CUSTOM_ATTRIBUTE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            INNER JOIN deleted AS d ON d.CUSTOM_ATTRIBUTE_URN = datagc.INT_KEY
