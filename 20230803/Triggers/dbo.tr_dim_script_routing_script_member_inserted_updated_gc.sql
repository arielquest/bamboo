...
GO
CREATE TRIGGER [dbo].[tr_dim_script_routing_script_member_inserted_updated_gc] ON [dbo].[TB_DIM_SCRIPT_ROUTING_SCRIPT_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_scriptroutingscriptmemTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SCRIPT_ROUTING_SCRIPT_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SCRIPT_ROUTING_SCRIPT_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_scriptroutingscriptmemTran;
            END;
            ELSE BEGIN 
