...
GO
CREATE TRIGGER [dbo].[tr_dim_va_domain_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_DOMAIN_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vadomPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_DOMAIN_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_DOMAIN_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'cca73037-399c-4e7d-a53c-6527a62e8b1e'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vadomPKEYTran;
            END;
            ELSE BEGIN 
