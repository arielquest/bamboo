...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_review_stage_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_REVIEW_STAGE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_REVIEW_STAGE_GC dgc
