...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_routing_target_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_ROUTING_TARGET] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_IVR_ROUTING_TARGET_GC dgc
