...
GO
CREATE TRIGGER [dbo].[tr_dim_va_classifier_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_CLASSIFIER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vaclassifPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_CLASSIFIER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_CLASSIFIER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '88fefca3-3fc1-4718-bc4d-8cfbc53ddfd7'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vaclassifPKEYTran;
            END;
            ELSE BEGIN 
