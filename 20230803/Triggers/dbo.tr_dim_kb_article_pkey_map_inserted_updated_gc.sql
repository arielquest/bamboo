...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbartiPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_ARTICLE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'e349b610-402f-4a1a-b555-ba26abdc6f30'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbartiPKEYTran;
            END;
            ELSE BEGIN 
