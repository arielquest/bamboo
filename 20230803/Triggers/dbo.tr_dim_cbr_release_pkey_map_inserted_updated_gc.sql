...
GO
CREATE TRIGGER [dbo].[tr_dim_cbr_release_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CBR_RELEASE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_cbrrelePKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CBR_RELEASE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CBR_RELEASE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '8af98ba5-936d-40a0-b7aa-f98163f18c9c'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_cbrrelePKEYTran;
            END;
            ELSE BEGIN 
