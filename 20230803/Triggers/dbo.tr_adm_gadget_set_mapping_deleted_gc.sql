...
GO
CREATE TRIGGER [dbo].[tr_adm_gadget_set_mapping_deleted_gc] ON [dbo].[TB_ADM_GADGET_SET_MAPPING] FOR DELETE
AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            INNER JOIN deleted AS d ON d.GADGET_SET_MAPPING_ID = datagc.GUID_KEY
