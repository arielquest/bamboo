...
GO
CREATE TRIGGER [dbo].[tr_dim_device_pool_date_time_setting_member_inserted_updated_gc] ON [dbo].[TB_DIM_DEVICE_POOL_DATE_TIME_SETTING_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_devicepooldatetimesettTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_DEVICE_POOL_DATE_TIME_SETTING_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_DEVICE_POOL_DATE_TIME_SETTING_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_devicepooldatetimesettTran;
            END;
            ELSE BEGIN 
