...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_script_node_exit_state_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_SCRIPT_NODE_EXIT_STATE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ivrscriptnodeexitstatPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IVR_SCRIPT_NODE_EXIT_STATE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IVR_SCRIPT_NODE_EXIT_STATE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '7b7acf0f-bf74-46de-b8f6-65b46e94f80c'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ivrscriptnodeexitstatPKEYTran;
            END;
            ELSE BEGIN 
