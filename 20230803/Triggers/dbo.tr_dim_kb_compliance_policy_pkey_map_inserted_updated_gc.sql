...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_compliance_policy_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbcompliancepolPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_COMPLIANCE_POLICY_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '555644c0-afa2-498d-b7fa-038a00f821f0'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbcompliancepolPKEYTran;
            END;
            ELSE BEGIN 
