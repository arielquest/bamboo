...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_compliance_policy_inserted_updated_gc] ON [dbo].[TB_DIM_KB_COMPLIANCE_POLICY] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_KB_COMPLIANCE_POLICY_GC dgc
