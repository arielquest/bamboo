...
GO
CREATE TRIGGER [dbo].[tr_dim_application_user_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_APPLICATION_USER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_applicationuPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_APPLICATION_USER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_APPLICATION_USER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '56e734bc-473a-46a8-ad35-54a0cd39b963'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_applicationuPKEYTran;
            END;
            ELSE BEGIN 
