...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_portal_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_PORTAL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbporPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_PORTAL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_PORTAL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '81e33d5a-42f6-4a6d-9753-561cefe6136f'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbporPKEYTran;
            END;
            ELSE BEGIN 
