...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_question_ghe_answer_member_pkey_map_inserted] ON [dbo].[TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
