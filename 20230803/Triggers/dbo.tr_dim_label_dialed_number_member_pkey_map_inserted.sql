...
GO
CREATE TRIGGER [dbo].[tr_dim_label_dialed_number_member_pkey_map_inserted] ON [dbo].[TB_DIM_LABEL_DIALED_NUMBER_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
