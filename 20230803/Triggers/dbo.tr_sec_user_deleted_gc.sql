...
GO
CREATE TRIGGER [dbo].[tr_sec_user_deleted_gc] ON [dbo].[TB_SEC_USER] FOR DELETE AS 
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    DECLARE @ErrorMessage AS NVARCHAR(500), @ErrorCode AS [INTEGER], @InitialTransactionCount AS [INTEGER], @TableGenerationCount AS BIGINT, @TableGenerationCountUrn AS INT, @UserRecordCount AS INT;
