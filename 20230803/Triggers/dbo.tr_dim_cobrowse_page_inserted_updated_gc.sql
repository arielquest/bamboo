...
GO
CREATE TRIGGER [dbo].[tr_dim_cobrowse_page_inserted_updated_gc] ON [dbo].[TB_DIM_COBROWSE_PAGE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_COBROWSE_PAGE_GC dgc
