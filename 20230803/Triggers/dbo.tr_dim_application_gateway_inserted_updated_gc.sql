...
GO
CREATE TRIGGER [dbo].[tr_dim_application_gateway_inserted_updated_gc] ON [dbo].[TB_DIM_APPLICATION_GATEWAY] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_APPLICATION_GATEWAY_GC dgc
