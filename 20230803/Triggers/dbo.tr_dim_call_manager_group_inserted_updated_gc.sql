...
GO
CREATE TRIGGER [dbo].[tr_dim_call_manager_group_inserted_updated_gc] ON [dbo].[TB_DIM_CALL_MANAGER_GROUP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_CALL_MANAGER_GROUP_GC dgc
