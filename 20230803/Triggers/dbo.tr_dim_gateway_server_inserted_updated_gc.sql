...
GO
CREATE TRIGGER [dbo].[tr_dim_gateway_server_inserted_updated_gc] ON [dbo].[TB_DIM_GATEWAY_SERVER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_GATEWAY_SERVER_GC dgc
