...
GO
CREATE TRIGGER [dbo].[tr_dim_enterprise_service_inserted_updated_gc] ON [dbo].[TB_DIM_ENTERPRISE_SERVICE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_ENTERPRISE_SERVICE_GC dgc
