...
GO
CREATE TRIGGER [dbo].[tr_dim_va_category_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_CATEGORY_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vacategPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_CATEGORY_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_CATEGORY_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '533f3ee4-334c-4d8b-a04c-a88efc120b55'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vacategPKEYTran;
            END;
            ELSE BEGIN 
