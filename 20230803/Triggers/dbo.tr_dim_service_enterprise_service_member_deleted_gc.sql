...
GO
CREATE TRIGGER [dbo].[tr_dim_service_enterprise_service_member_deleted_gc] ON [dbo].[TB_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER_GC AS datagc
