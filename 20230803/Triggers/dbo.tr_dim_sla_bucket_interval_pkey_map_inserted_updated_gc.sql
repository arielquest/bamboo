...
GO
CREATE TRIGGER [dbo].[tr_dim_sla_bucket_interval_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_SLA_BUCKET_INTERVAL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_slabucketinterPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SLA_BUCKET_INTERVAL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SLA_BUCKET_INTERVAL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '2be66c38-5592-4dba-bc11-81d3395163b0'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_slabucketinterPKEYTran;
            END;
            ELSE BEGIN 
