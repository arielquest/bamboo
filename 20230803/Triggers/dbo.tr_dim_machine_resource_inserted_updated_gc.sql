...
GO
CREATE TRIGGER [dbo].[tr_dim_machine_resource_inserted_updated_gc] ON [dbo].[TB_DIM_MACHINE_RESOURCE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_MACHINE_RESOURCE_GC dgc
