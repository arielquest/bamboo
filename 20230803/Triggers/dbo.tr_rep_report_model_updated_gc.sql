...
GO
CREATE TRIGGER [dbo].[tr_rep_report_model_updated_gc] ON [dbo].[TB_REP_REPORT_MODEL]
    FOR UPDATE
AS
BEGIN 
    SET XACT_ABORT OFF;
    ...
    WHERE   TABLE_NAME = 'TB_REP_REPORT_MODEL';
    ...
    JOIN    inserted AS d ON d.REPORT_MODEL_ID = datagc.GUID_KEY
    ...
    BEGIN 
        ...
        SELECT  @TableGenerationCountUrn,
                ...
                'U'
        FROM    inserted AS i
        WHERE   NOT EXISTS ( SELECT d.REPORT_MODEL_ID
                             FROM   dbo.TS_ADM_DATA_GENERATION_COUNT AS datagc
                             JOIN   inserted AS d ON d.REPORT_MODEL_ID = datagc.GUID_KEY
                             WHERE  datagc.TABLE_GENERATION_COUNT_URN = @TableGenerationCountUrn
                                    AND d.REPORT_MODEL_ID = i.REPORT_MODEL_ID );
