...
GO
CREATE TRIGGER [dbo].[tr_dim_va_score_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_SCORE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vascPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_SCORE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_SCORE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '579e33cc-95e5-4fe9-bc4c-3ff3045d4eee'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vascPKEYTran;
            END;
            ELSE BEGIN 
