...
GO
CREATE TRIGGER [dbo].[tr_dim_trunk_group_network_trunk_group_member_inserted_updated_gc] ON [dbo].[TB_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_trunkgroupnetworktrunkTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_trunkgroupnetworktrunkTran;
            END;
            ELSE BEGIN 
