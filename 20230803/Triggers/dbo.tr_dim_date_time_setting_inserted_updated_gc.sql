...
GO
CREATE TRIGGER [dbo].[tr_dim_date_time_setting_inserted_updated_gc] ON [dbo].[TB_DIM_DATE_TIME_SETTING] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_DATE_TIME_SETTING_GC dgc
