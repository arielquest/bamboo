...
GO
CREATE TRIGGER [dbo].[tr_dim_entry_point_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ENTRY_POINT_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_entrypoPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_ENTRY_POINT_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_ENTRY_POINT_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '9d660b17-9af3-43ec-a6b8-ec8e0d74c2a0'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_entrypoPKEYTran;
            END;
            ELSE BEGIN 
