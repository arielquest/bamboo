...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_directory_number_member_inserted_updated_gc] ON [dbo].[TB_DIM_IP_ENDPOINT_DIRECTORY_NUMBER_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ipendpointdirectorynumTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IP_ENDPOINT_DIRECTORY_NUMBER_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IP_ENDPOINT_DIRECTORY_NUMBER_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ipendpointdirectorynumTran;
            END;
            ELSE BEGIN 
