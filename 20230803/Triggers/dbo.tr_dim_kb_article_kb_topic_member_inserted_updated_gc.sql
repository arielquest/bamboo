...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_kb_topic_member_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_KB_TOPIC_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbarticlekbtopicmemTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_ARTICLE_KB_TOPIC_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_KB_TOPIC_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbarticlekbtopicmemTran;
            END;
            ELSE BEGIN 
