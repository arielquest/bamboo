...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_channel_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_CHANNEL] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_NOTIFY_CHANNEL_GC dgc
