...
GO
CREATE TRIGGER [dbo].[tr_dim_hierarchy_level_deleted_gc] ON [dbo].[TB_DIM_HIERARCHY_LEVEL] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.HIERARCHY_LEVEL_URN = datagc.INT_KEY
