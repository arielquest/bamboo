...
GO
CREATE TRIGGER [dbo].[tr_dim_user_variable_inserted_updated_gc] ON [dbo].[TB_DIM_USER_VARIABLE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_USER_VARIABLE_GC dgc
