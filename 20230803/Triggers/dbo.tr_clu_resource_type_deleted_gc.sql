...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_type_deleted_gc] ON [dbo].[TE_ADM_CLUSTER_RESOURCE_TYPE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.CLUSTER_RESOURCE_TYPE_ID = datagc.GUID_KEY
