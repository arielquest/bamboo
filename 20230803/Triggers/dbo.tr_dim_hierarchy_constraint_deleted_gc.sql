...
GO
CREATE TRIGGER [dbo].[tr_dim_hierarchy_constraint_deleted_gc] ON [dbo].[TB_DIM_HIERARCHY_CONSTRAINT] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.HIERARCHY_CONSTRAINT_URN = datagc.INT_KEY
