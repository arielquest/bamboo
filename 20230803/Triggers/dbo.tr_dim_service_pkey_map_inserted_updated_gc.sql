...
GO
CREATE TRIGGER [dbo].[tr_dim_service_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_SERVICE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_servPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SERVICE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SERVICE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '00007500-1000-0000-0000-000000000010'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_servPKEYTran;
            END;
            ELSE BEGIN 
