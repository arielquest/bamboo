...
GO
CREATE TRIGGER [dbo].[tr_dim_va_intent_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_INTENT_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vaintPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_INTENT_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_INTENT_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '1792bcc6-de73-4bb5-96ab-9ca671dc4245'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vaintPKEYTran;
            END;
            ELSE BEGIN 
