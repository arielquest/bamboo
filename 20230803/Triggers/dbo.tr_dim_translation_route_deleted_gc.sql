...
GO
CREATE TRIGGER [dbo].[tr_dim_translation_route_deleted_gc] ON [dbo].[TB_DIM_TRANSLATION_ROUTE] FOR DELETE
AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_TRANSLATION_ROUTE_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_TRANSLATION_ROUTE_GC AS datagc
