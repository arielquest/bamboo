...
GO
CREATE TRIGGER [dbo].[tr_dim_va_case_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_CASE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vacPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_CASE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_CASE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'bc92cc12-300f-442c-83de-1a8bcd86d28f'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vacPKEYTran;
            END;
            ELSE BEGIN 
