...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_peripheral_member_pkey_map_inserted] ON [dbo].[TB_DIM_IP_ENDPOINT_PERIPHERAL_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
