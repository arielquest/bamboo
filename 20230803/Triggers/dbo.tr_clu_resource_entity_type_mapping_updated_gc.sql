...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_entity_type_mapping_updated_gc] ON [dbo].[TB_CLU_RESOURCE_ENTITY_TYPE_MAPPING]
    FOR UPDATE
AS
BEGIN 
    SET XACT_ABORT OFF;
    ...
    JOIN    inserted AS d ON d.ID = datagc.GUID_KEY
