...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_directory_number_member_inserted] ON [dbo].[TB_DIM_IP_ENDPOINT_DIRECTORY_NUMBER_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
