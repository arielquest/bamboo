...
GO
CREATE TRIGGER [dbo].[tr_clu_connection_type_deleted_gc] ON [dbo].[TE_CLU_CONNECTION_TYPE] FOR DELETE
AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.CONNECTION_TYPE_ID = datagc.GUID_KEY
