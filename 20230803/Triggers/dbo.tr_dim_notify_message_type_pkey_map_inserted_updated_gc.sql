...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_message_type_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_MESSAGE_TYPE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_notifymessagetPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NOTIFY_MESSAGE_TYPE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NOTIFY_MESSAGE_TYPE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'a1a245cd-acce-4d76-9839-7a589515601a'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_notifymessagetPKEYTran;
            END;
            ELSE BEGIN 
