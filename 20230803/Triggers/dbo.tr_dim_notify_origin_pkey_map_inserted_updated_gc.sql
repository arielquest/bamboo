...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_origin_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_ORIGIN_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_notifyoriPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NOTIFY_ORIGIN_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NOTIFY_ORIGIN_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'da79488a-e823-4675-aa30-89f3847874ea'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_notifyoriPKEYTran;
            END;
            ELSE BEGIN 
