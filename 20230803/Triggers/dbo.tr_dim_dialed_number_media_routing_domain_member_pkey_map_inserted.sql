...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_media_routing_domain_member_pkey_map_inserted] ON [dbo].[TB_DIM_DIALED_NUMBER_MEDIA_ROUTING_DOMAIN_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
