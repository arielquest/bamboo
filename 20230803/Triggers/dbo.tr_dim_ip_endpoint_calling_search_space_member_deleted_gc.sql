...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_calling_search_space_member_deleted_gc] ON [dbo].[TB_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER_GC AS datagc
