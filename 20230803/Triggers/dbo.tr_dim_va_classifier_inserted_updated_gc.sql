...
GO
CREATE TRIGGER [dbo].[tr_dim_va_classifier_inserted_updated_gc] ON [dbo].[TB_DIM_VA_CLASSIFIER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_VA_CLASSIFIER_GC dgc
