...
GO
CREATE TRIGGER [dbo].[tr_dim_agent_person_member_inserted_updated_gc] ON [dbo].[TB_DIM_AGENT_PERSON_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_agentpersonmemTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_AGENT_PERSON_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_AGENT_PERSON_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_agentpersonmemTran;
            END;
            ELSE BEGIN 
