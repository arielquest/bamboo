...
GO
CREATE TRIGGER [dbo].[tr_dim_trunk_group_network_trunk_group_member_deleted_gc] ON [dbo].[TB_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER_GC AS datagc
