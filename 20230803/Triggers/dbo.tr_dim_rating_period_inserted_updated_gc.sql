...
GO
CREATE TRIGGER [dbo].[tr_dim_rating_period_inserted_updated_gc] ON [dbo].[TB_DIM_RATING_PERIOD] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_RATING_PERIOD_GC dgc
