...
GO
CREATE TRIGGER [dbo].[tr_dim_calling_search_space_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CALLING_SEARCH_SPACE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_callingsearchspPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CALLING_SEARCH_SPACE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CALLING_SEARCH_SPACE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '00010700-1000-0000-0000-000000000010'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_callingsearchspPKEYTran;
            END;
            ELSE BEGIN 
