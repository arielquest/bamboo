...
GO
CREATE TRIGGER [dbo].[tr_dim_service_enterprise_service_member_inserted] ON [dbo].[TB_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
