...
GO
CREATE TRIGGER [dbo].[tr_dim_network_vru_script_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_NETWORK_VRU_SCRIPT_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_networkvruscrPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NETWORK_VRU_SCRIPT_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NETWORK_VRU_SCRIPT_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'aaf3357b-5222-416d-887f-2e6678c73910'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_networkvruscrPKEYTran;
            END;
            ELSE BEGIN 
