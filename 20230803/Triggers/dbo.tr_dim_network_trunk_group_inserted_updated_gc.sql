...
GO
CREATE TRIGGER [dbo].[tr_dim_network_trunk_group_inserted_updated_gc] ON [dbo].[TB_DIM_NETWORK_TRUNK_GROUP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_NETWORK_TRUNK_GROUP_GC dgc
