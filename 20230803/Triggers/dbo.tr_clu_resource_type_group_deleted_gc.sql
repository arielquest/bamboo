...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_type_group_deleted_gc] ON [dbo].[TE_CLU_RESOURCE_TYPE_GROUP] FOR DELETE
AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.RESOURCE_TYPE_GROUP_ID = datagc.GUID_KEY
