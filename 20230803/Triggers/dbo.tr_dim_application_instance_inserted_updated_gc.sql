...
GO
CREATE TRIGGER [dbo].[tr_dim_application_instance_inserted_updated_gc] ON [dbo].[TB_DIM_APPLICATION_INSTANCE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_APPLICATION_INSTANCE_GC dgc
