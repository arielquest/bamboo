...
GO
CREATE TRIGGER [dbo].[tr_dim_device_pool_date_time_setting_member_pkey_map_inserted] ON [dbo].[TB_DIM_DEVICE_POOL_DATE_TIME_SETTING_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
