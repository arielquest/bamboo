...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_routing_client_member_inserted] ON [dbo].[TB_DIM_DIALED_NUMBER_ROUTING_CLIENT_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
