...
GO
CREATE TRIGGER [dbo].[tr_dim_gateway_function_inserted_updated_gc] ON [dbo].[TB_DIM_GATEWAY_FUNCTION] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_GATEWAY_FUNCTION_GC dgc
