...
GO
CREATE TRIGGER [dbo].[tr_dim_content_url_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CONTENT_URL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_contentPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CONTENT_URL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CONTENT_URL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '12f8f3fd-b2d4-4d48-aee6-52ed6c359ac9'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_contentPKEYTran;
            END;
            ELSE BEGIN 
