...
GO
CREATE TRIGGER [dbo].[tr_dim_custom_entry_custom_member_pkey_map_inserted] ON [dbo].[TB_DIM_CUSTOM_ENTRY_CUSTOM_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
