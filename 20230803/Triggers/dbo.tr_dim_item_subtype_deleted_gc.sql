...
GO
CREATE TRIGGER [dbo].[tr_dim_item_subtype_deleted_gc] ON [dbo].[TE_DIM_ITEM_SUBTYPE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.ITEM_SUBTYPE_ID = datagc.GUID_KEY
