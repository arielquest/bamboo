...
GO
CREATE TRIGGER [dbo].[tr_dim_alias_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ALIAS_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_alPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_ALIAS_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_ALIAS_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'd681b841-a1d4-4be8-8538-f75c40f524eb'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_alPKEYTran;
            END;
            ELSE BEGIN 
