...
GO
CREATE TRIGGER [dbo].[tr_dim_mediafile_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_MEDIAFILE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_mediafPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_MEDIAFILE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_MEDIAFILE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'd500e079-8a45-44b3-8068-f5dfe64297d5'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_mediafPKEYTran;
            END;
            ELSE BEGIN 
