...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_cluster_group_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_CLUSTER_GROUP_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_gheclustergrPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_CLUSTER_GROUP_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_CLUSTER_GROUP_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '81674c53-6785-4f4f-a6d7-27f180c520f8'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_gheclustergrPKEYTran;
            END;
            ELSE BEGIN 
