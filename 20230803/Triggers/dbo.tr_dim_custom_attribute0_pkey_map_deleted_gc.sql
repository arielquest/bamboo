...
GO
CREATE TRIGGER [dbo].[tr_dim_custom_attribute0_pkey_map_deleted_gc] ON [dbo].[TB_DIM_CUSTOM_ATTRIBUTE0_PKEY_MAP] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_CUSTOM_ATTRIBUTE0_PKEY_MAP_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_CUSTOM_ATTRIBUTE0_PKEY_MAP_GC AS datagc
