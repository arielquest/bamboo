...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_cluster_ghe_cluster_group_member_pkey_map_inserted] ON [dbo].[TB_DIM_GHE_CLUSTER_GHE_CLUSTER_GROUP_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
