...
GO
CREATE TRIGGER [dbo].[tr_dim_agent_team_peripheral_member_pkey_map_inserted] ON [dbo].[TB_DIM_AGENT_TEAM_PERIPHERAL_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
