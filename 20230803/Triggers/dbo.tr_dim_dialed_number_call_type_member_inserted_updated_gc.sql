...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_call_type_member_inserted_updated_gc] ON [dbo].[TB_DIM_DIALED_NUMBER_CALL_TYPE_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_dialednumbercalltypemeTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_DIALED_NUMBER_CALL_TYPE_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_DIALED_NUMBER_CALL_TYPE_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_dialednumbercalltypemeTran;
            END;
            ELSE BEGIN 
