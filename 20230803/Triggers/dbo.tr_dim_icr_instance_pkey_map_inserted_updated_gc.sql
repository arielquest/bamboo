...
GO
CREATE TRIGGER [dbo].[tr_dim_icr_instance_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ICR_INSTANCE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_ICR_INSTANCE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '00009500-1000-0000-0000-000000000010'
