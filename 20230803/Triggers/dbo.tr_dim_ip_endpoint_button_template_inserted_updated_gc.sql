...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_button_template_inserted_updated_gc] ON [dbo].[TB_DIM_IP_ENDPOINT_BUTTON_TEMPLATE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_IP_ENDPOINT_BUTTON_TEMPLATE_GC dgc
