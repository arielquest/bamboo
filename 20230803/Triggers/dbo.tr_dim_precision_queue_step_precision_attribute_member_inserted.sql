...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_step_precision_attribute_member_inserted] ON [dbo].[TB_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
