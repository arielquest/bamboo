...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_kb_topic_member_pkey_map_inserted] ON [dbo].[TB_DIM_KB_ARTICLE_KB_TOPIC_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
