...
GO
CREATE TRIGGER [dbo].[tr_adm_gadget_version_inserted_updated_gc] ON [dbo].[TB_ADM_GADGET_VERSION]
    FOR INSERT, UPDATE
AS
    BEGIN 
        SET XACT_ABORT OFF;
    ...
    -- Return early if no rows or if it is an update is by replication on the msrepl_tran_version column
        ...
        BEGIN 
            ...
            -- Update and Get Table Generation Count
                EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_ADM_GADGET_VERSION',
