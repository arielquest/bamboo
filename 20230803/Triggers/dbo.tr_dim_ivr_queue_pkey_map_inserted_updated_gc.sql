...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_queue_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_QUEUE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ivrquPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IVR_QUEUE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IVR_QUEUE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '864531e7-3fba-4284-9ad9-d18aa7c6027f'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ivrquPKEYTran;
            END;
            ELSE BEGIN 
