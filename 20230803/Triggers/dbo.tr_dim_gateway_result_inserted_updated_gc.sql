...
GO
CREATE TRIGGER [dbo].[tr_dim_gateway_result_inserted_updated_gc] ON [dbo].[TB_DIM_GATEWAY_RESULT] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_GATEWAY_RESULT_GC dgc
