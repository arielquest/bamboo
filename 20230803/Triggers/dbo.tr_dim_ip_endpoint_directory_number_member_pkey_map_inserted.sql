...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_directory_number_member_pkey_map_inserted] ON [dbo].[TB_DIM_IP_ENDPOINT_DIRECTORY_NUMBER_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
