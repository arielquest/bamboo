...
GO
CREATE TRIGGER [dbo].[tr_dim_media_routing_domain_media_class_member_deleted_gc] ON [dbo].[TB_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER_GC AS datagc
