...
GO
CREATE TRIGGER [dbo].[tr_sec_user_pkey_map_inserted] ON [dbo].[TB_SEC_USER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION sec_user_pkey_insert_trg;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            BEGIN 
               COMMIT TRANSACTION sec_user_pkey_insert_trg;
            END;
            ELSE BEGIN 
