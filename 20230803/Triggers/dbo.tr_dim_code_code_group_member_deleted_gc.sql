...
GO
CREATE TRIGGER [dbo].[tr_dim_code_code_group_member_deleted_gc] ON [dbo].[TB_DIM_CODE_CODE_GROUP_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_CODE_CODE_GROUP_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_CODE_CODE_GROUP_MEMBER_GC AS datagc
