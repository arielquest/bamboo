...
GO
CREATE TRIGGER [dbo].[tr_dim_agent_agent_desktop_member_pkey_map_inserted] ON [dbo].[TB_DIM_AGENT_AGENT_DESKTOP_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
