...
GO
CREATE TRIGGER [dbo].[tr_dim_custom_attribute9_inserted_updated_gc] ON [dbo].[TB_DIM_CUSTOM_ATTRIBUTE9] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_CUSTOM_ATTRIBUTE9_GC dgc
