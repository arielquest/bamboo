...
GO
CREATE TRIGGER [dbo].[tr_dim_trunk_group_network_trunk_group_member_pkey_map_inserted] ON [dbo].[TB_DIM_TRUNK_GROUP_NETWORK_TRUNK_GROUP_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
