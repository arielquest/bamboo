...
GO
CREATE TRIGGER [dbo].[tr_dim_va_attribute_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_ATTRIBUTE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vaattribPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_ATTRIBUTE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_ATTRIBUTE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '4ded5469-18cd-4817-96db-6e73b7c69656'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vaattribPKEYTran;
            END;
            ELSE BEGIN 
