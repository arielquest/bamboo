...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_origin_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_ORIGIN] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_NOTIFY_ORIGIN_GC dgc
