...
GO
CREATE TRIGGER [dbo].[tr_rep_analyzer_model_deleted_gc] ON [dbo].[TB_REP_ANALYZER_MODEL] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            INNER JOIN deleted AS d ON d.ANALYZER_MODEL_URN = datagc.INT_KEY
