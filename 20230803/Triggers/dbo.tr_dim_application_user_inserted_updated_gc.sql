...
GO
CREATE TRIGGER [dbo].[tr_dim_application_user_inserted_updated_gc] ON [dbo].[TB_DIM_APPLICATION_USER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_APPLICATION_USER_GC dgc
