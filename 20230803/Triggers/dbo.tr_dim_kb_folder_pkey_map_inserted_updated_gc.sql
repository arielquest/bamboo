...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_folder_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_FOLDER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbfolPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_FOLDER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_FOLDER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '1efc44cf-d313-4bf5-9be7-a4a893d68d2c'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbfolPKEYTran;
            END;
            ELSE BEGIN 
