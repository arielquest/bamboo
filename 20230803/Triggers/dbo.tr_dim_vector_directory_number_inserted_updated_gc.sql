...
GO
CREATE TRIGGER [dbo].[tr_dim_vector_directory_number_inserted_updated_gc] ON [dbo].[TB_DIM_VECTOR_DIRECTORY_NUMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_VECTOR_DIRECTORY_NUMBER_GC dgc
