...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_category_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_CATEGORY_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_notifycategPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NOTIFY_CATEGORY_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NOTIFY_CATEGORY_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'b85aa2b4-6c2a-44e8-b103-8e0bf64749b7'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_notifycategPKEYTran;
            END;
            ELSE BEGIN 
