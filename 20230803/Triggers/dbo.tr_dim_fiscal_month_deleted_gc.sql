...
GO
CREATE TRIGGER [dbo].[tr_dim_fiscal_month_deleted_gc] ON [dbo].[TB_DIM_FISCAL_MONTH] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.FISCAL_MONTH_URN = datagc.INT_KEY
