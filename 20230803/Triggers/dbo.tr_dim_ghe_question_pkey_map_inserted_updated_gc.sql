...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_question_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_QUESTION_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ghequestPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_QUESTION_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_QUESTION_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '95009762-fc8e-4303-8096-86fb24ec0cb3'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ghequestPKEYTran;
            END;
            ELSE BEGIN 
