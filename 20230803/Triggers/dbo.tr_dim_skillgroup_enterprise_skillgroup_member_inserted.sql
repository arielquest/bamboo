...
GO
CREATE TRIGGER [dbo].[tr_dim_skillgroup_enterprise_skillgroup_member_inserted] ON [dbo].[TB_DIM_SKILLGROUP_ENTERPRISE_SKILLGROUP_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
