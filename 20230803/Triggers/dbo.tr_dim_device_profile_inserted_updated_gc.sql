...
GO
CREATE TRIGGER [dbo].[tr_dim_device_profile_inserted_updated_gc] ON [dbo].[TB_DIM_DEVICE_PROFILE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_DEVICE_PROFILE_GC dgc
