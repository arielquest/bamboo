...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_entry_point_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_ENTRY_POINT] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_IVR_ENTRY_POINT_GC dgc
