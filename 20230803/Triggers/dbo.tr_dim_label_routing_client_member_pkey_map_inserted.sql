...
GO
CREATE TRIGGER [dbo].[tr_dim_label_routing_client_member_pkey_map_inserted] ON [dbo].[TB_DIM_LABEL_ROUTING_CLIENT_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
