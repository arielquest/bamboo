...
GO
CREATE TRIGGER [dbo].[tr_dim_peripheral_logical_interface_controller_member_inserted_updated_gc] ON [dbo].[TB_DIM_PERIPHERAL_LOGICAL_INTERFACE_CONTROLLER_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_peripherallogicalinterTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_PERIPHERAL_LOGICAL_INTERFACE_CONTROLLER_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_PERIPHERAL_LOGICAL_INTERFACE_CONTROLLER_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_peripherallogicalinterTran;
            END;
            ELSE BEGIN 
