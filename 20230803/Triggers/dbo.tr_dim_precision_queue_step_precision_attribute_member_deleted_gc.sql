...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_step_precision_attribute_member_deleted_gc] ON [dbo].[TB_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER_GC AS datagc
