...
GO
CREATE TRIGGER [dbo].[tr_dim_network_vru_script_network_vru_member_inserted_updated_gc] ON [dbo].[TB_DIM_NETWORK_VRU_SCRIPT_NETWORK_VRU_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_networkvruscriptnetworTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_NETWORK_VRU_SCRIPT_NETWORK_VRU_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_NETWORK_VRU_SCRIPT_NETWORK_VRU_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_networkvruscriptnetworTran;
            END;
            ELSE BEGIN 
