...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_instance_component_type_deleted_gc] ON [dbo].[TE_CLU_RESOURCE_INSTANCE_COMPONENT_TYPE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.COMPONENT_TYPE_ID = datagc.GUID_KEY
