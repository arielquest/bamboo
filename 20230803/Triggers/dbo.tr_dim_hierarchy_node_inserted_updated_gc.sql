...
GO
CREATE TRIGGER [dbo].[tr_dim_hierarchy_node_inserted_updated_gc] ON [dbo].[TB_DIM_HIERARCHY_NODE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_HIERARCHY_NODE_GC dgc
