...
GO
CREATE TRIGGER [dbo].[tr_dim_machine_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_MACHINE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_machPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_MACHINE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_MACHINE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'dd962dbf-c1fb-4637-985d-81c710d19e15'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_machPKEYTran;
            END;
            ELSE BEGIN 
