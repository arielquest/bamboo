...
GO
CREATE TRIGGER [dbo].[tr_dim_bucket_interval_inserted_updated_gc] ON [dbo].[TB_DIM_BUCKET_INTERVAL] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_BUCKET_INTERVAL_GC dgc
