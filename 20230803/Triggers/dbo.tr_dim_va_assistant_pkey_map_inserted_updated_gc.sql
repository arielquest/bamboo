...
GO
CREATE TRIGGER [dbo].[tr_dim_va_assistant_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_ASSISTANT_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vaassistPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_ASSISTANT_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_ASSISTANT_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '18a81360-359d-4922-91d7-98b0e903db18'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vaassistPKEYTran;
            END;
            ELSE BEGIN 
