...
GO
CREATE TRIGGER [dbo].[tr_dim_offer_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_OFFER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ofPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_OFFER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_OFFER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'dbc2a99b-996e-4c94-be3b-af3ce1e7341d'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ofPKEYTran;
            END;
            ELSE BEGIN 
