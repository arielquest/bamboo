...
GO
CREATE TRIGGER [dbo].[tr_dim_queue_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_QUEUE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_quPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_QUEUE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_QUEUE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '61a20821-ae86-4d50-b6a9-502d89453907'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_quPKEYTran;
            END;
            ELSE BEGIN 
