...
GO
CREATE TRIGGER [dbo].[tr_adm_gadget_version_file_deleted_gc] ON [dbo].[TB_ADM_GADGET_VERSION_FILE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC dbo.ap_adm01_increment_table_generation_count @TableName = 'TB_ADM_GADGET_VERSION_FILE', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT, @TableGenerationCountUrn = @TableGenerationCountUrn OUTPUT;
