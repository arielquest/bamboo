...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_answer_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_ANSWER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_gheansPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_ANSWER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_ANSWER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'b1dc6b14-72cf-4c51-876e-1da1e1f63b74'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_gheansPKEYTran;
            END;
            ELSE BEGIN 
