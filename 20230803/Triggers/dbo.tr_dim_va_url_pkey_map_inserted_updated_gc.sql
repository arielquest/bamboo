...
GO
CREATE TRIGGER [dbo].[tr_dim_va_url_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_URL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vaPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_URL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_URL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'be47e0e6-c335-4e2f-8586-c31a164afbfa'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vaPKEYTran;
            END;
            ELSE BEGIN 
