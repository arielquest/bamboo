...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_member_deleted_gc] ON [dbo].[TB_CLU_RESOURCE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.RESOURCE_MEMBER_ID = datagc.GUID_KEY
