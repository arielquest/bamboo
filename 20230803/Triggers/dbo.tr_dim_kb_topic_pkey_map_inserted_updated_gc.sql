...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_topic_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_TOPIC_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbtoPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_TOPIC_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_TOPIC_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'd82c0660-b9ee-4da4-8b19-2861120ca90a'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbtoPKEYTran;
            END;
            ELSE BEGIN 
