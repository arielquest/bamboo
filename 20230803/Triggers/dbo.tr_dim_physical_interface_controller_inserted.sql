...
GO
CREATE TRIGGER [dbo].[tr_dim_physical_interface_controller_inserted]  ON [dbo].[TB_DIM_PHYSICAL_INTERFACE_CONTROLLER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            BEGIN 
                ...
                SET ITEM_BIZ_URN = ISNULL(NULLIF(ITEM_BIZ_URN,-2),ITEM_URN)
