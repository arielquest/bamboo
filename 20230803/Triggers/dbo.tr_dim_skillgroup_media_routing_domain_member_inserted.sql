...
GO
CREATE TRIGGER [dbo].[tr_dim_skillgroup_media_routing_domain_member_inserted] ON [dbo].[TB_DIM_SKILLGROUP_MEDIA_ROUTING_DOMAIN_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
