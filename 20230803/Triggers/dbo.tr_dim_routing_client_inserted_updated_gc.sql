...
GO
CREATE TRIGGER [dbo].[tr_dim_routing_client_inserted_updated_gc] ON [dbo].[TB_DIM_ROUTING_CLIENT] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_ROUTING_CLIENT_GC dgc
