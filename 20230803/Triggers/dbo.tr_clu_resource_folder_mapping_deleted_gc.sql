...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_folder_mapping_deleted_gc] ON [dbo].[TB_CLU_RESOURCE_FOLDER_MAPPING] FOR DELETE AS 
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.MAPPING_ID = datagc.GUID_KEY
