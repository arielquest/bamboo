...
GO
CREATE TRIGGER [dbo].[tr_dim_call_type_bucket_interval_member_pkey_map_inserted] ON [dbo].[TB_DIM_CALL_TYPE_BUCKET_INTERVAL_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
