...
GO
CREATE TRIGGER [dbo].[tr_dim_uc_service_profile_inserted_updated_gc] ON [dbo].[TB_DIM_UC_SERVICE_PROFILE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_UC_SERVICE_PROFILE_GC dgc
