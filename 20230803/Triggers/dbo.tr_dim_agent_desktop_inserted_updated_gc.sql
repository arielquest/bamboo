...
GO
CREATE TRIGGER [dbo].[tr_dim_agent_desktop_inserted_updated_gc] ON [dbo].[TB_DIM_AGENT_DESKTOP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_AGENT_DESKTOP_GC dgc
