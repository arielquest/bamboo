...
GO
CREATE TRIGGER [dbo].[tr_dim_media_routing_domain_media_class_member_inserted_updated_gc] ON [dbo].[TB_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_mediaroutingdomainmediTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_mediaroutingdomainmediTran;
            END;
            ELSE BEGIN 
