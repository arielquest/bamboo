...
GO
CREATE TRIGGER [dbo].[tr_dim_member_type_deleted_gc] ON [dbo].[TE_DIM_MEMBER_TYPE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    WHERE TABLE_NAME = 'TE_DIM_MEMBER_TYPE';
    ...
    INNER JOIN deleted AS d ON d.MEMBER_TYPE_ID = datagc.GUID_KEY
