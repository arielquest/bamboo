...
GO
CREATE TRIGGER [dbo].[tr_dim_scl_adapter_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_SCL_ADAPTER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_scladapPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SCL_ADAPTER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SCL_ADAPTER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '9ce7c8c9-76f1-4ffc-b809-861517f609f2'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_scladapPKEYTran;
            END;
            ELSE BEGIN 
