...
GO
CREATE TRIGGER [dbo].[tr_sec_search_folder_deleted_gc] ON [dbo].[TB_SEC_SEARCH_FOLDER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    IF NOT EXISTS (
    ...
    INNER JOIN deleted AS d ON d.SEARCH_FOLDER_ID = datagc.GUID_KEY
