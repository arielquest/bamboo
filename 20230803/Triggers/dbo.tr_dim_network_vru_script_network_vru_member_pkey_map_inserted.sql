...
GO
CREATE TRIGGER [dbo].[tr_dim_network_vru_script_network_vru_member_pkey_map_inserted] ON [dbo].[TB_DIM_NETWORK_VRU_SCRIPT_NETWORK_VRU_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
