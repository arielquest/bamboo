...
GO
CREATE TRIGGER [dbo].[tr_dim_dial_number_plan_inserted_updated_gc] ON [dbo].[TB_DIM_DIAL_NUMBER_PLAN] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_DIAL_NUMBER_PLAN_GC dgc
