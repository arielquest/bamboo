...
GO
CREATE TRIGGER [dbo].[tr_dim_media_routing_domain_media_class_member_pkey_map_inserted] ON [dbo].[TB_DIM_MEDIA_ROUTING_DOMAIN_MEDIA_CLASS_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
