...
GO
CREATE TRIGGER [dbo].[tr_dim_chat_referrer_name_inserted_updated_gc] ON [dbo].[TB_DIM_CHAT_REFERRER_NAME] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_CHAT_REFERRER_NAME_GC dgc
