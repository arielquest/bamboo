...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_inserted_updated_gc] ON [dbo].[TB_DIM_PRECISION_QUEUE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_PRECISION_QUEUE_GC dgc
