...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_step_precision_queue_member_pkey_map_inserted] ON [dbo].[TB_DIM_PRECISION_QUEUE_STEP_PRECISION_QUEUE_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
