...
GO
CREATE TRIGGER [dbo].[tr_dim_category_map_deleted_gc] ON [dbo].[TB_DIM_CATEGORY_MAP] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.CATEGORY_MAP_URN = datagc.INT_KEY
