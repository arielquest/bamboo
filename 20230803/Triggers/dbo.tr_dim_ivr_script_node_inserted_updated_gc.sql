...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_script_node_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_SCRIPT_NODE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_IVR_SCRIPT_NODE_GC dgc
