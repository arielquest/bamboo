...
GO
CREATE TRIGGER [dbo].[tr_dim_skillgroup_service_member_pkey_map_inserted] ON [dbo].[TB_DIM_SKILLGROUP_SERVICE_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
