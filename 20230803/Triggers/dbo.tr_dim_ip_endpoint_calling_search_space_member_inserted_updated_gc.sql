...
GO
CREATE TRIGGER [dbo].[tr_dim_ip_endpoint_calling_search_space_member_inserted_updated_gc] ON [dbo].[TB_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ipendpointcallingsearcTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IP_ENDPOINT_CALLING_SEARCH_SPACE_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ipendpointcallingsearcTran;
            END;
            ELSE BEGIN 
