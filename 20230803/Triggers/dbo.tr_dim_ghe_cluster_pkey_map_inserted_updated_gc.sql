...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_cluster_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_CLUSTER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_gheclusPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_CLUSTER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_CLUSTER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '36fee03e-be37-43d3-a3e9-4b13f6ccae5d'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_gheclusPKEYTran;
            END;
            ELSE BEGIN 
