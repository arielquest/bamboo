...
GO
CREATE TRIGGER [dbo].[tr_dim_physical_controller_logical_controller_member_inserted] ON [dbo].[TB_DIM_PHYSICAL_CONTROLLER_LOGICAL_CONTROLLER_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
