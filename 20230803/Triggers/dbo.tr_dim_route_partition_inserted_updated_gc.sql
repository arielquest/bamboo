...
GO
CREATE TRIGGER [dbo].[tr_dim_route_partition_inserted_updated_gc] ON [dbo].[TB_DIM_ROUTE_PARTITION] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_ROUTE_PARTITION_GC dgc
