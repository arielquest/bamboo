...
GO
CREATE TRIGGER [dbo].[tr_dim_chat_referrer_url_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CHAT_REFERRER_URL_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_chatreferrerPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CHAT_REFERRER_URL_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CHAT_REFERRER_URL_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'd12cd7df-e5b4-48c3-9129-b1d1c00325fd'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_chatreferrerPKEYTran;
            END;
            ELSE BEGIN 
