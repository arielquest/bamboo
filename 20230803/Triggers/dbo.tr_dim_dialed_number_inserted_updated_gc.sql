...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_inserted_updated_gc] ON [dbo].[TB_DIM_DIALED_NUMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_DIALED_NUMBER_GC dgc
