...
GO
CREATE TRIGGER [dbo].[tr_dim_item_hierarchy_node_member_deleted_gc] ON [dbo].[TB_DIM_ITEM_HIERARCHY_NODE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.MEMBER_URN = datagc.INT_KEY
