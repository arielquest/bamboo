...
GO
CREATE TRIGGER [dbo].[tr_dim_expanded_call_variable_inserted_updated_gc] ON [dbo].[TB_DIM_EXPANDED_CALL_VARIABLE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_EXPANDED_CALL_VARIABLE_GC dgc
