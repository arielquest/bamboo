...
GO
CREATE TRIGGER [dbo].[tr_dim_code_code_group_member_inserted_updated_gc] ON [dbo].[TB_DIM_CODE_CODE_GROUP_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_codecodegroupmemTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CODE_CODE_GROUP_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CODE_CODE_GROUP_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_codecodegroupmemTran;
            END;
            ELSE BEGIN 
