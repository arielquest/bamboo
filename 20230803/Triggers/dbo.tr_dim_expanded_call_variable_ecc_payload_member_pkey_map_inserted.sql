...
GO
CREATE TRIGGER [dbo].[tr_dim_expanded_call_variable_ecc_payload_member_pkey_map_inserted] ON [dbo].[TB_DIM_EXPANDED_CALL_VARIABLE_ECC_PAYLOAD_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
