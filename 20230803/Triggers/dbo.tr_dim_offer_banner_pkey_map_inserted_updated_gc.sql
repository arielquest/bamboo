...
GO
CREATE TRIGGER [dbo].[tr_dim_offer_banner_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_OFFER_BANNER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_offerbanPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_OFFER_BANNER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_OFFER_BANNER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'ac9eba20-25f8-44fb-8252-c4e65fa05ef0'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_offerbanPKEYTran;
            END;
            ELSE BEGIN 
