...
GO
CREATE TRIGGER [dbo].[tr_dim_vector_directory_number_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VECTOR_DIRECTORY_NUMBER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vectordirectorynumPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VECTOR_DIRECTORY_NUMBER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VECTOR_DIRECTORY_NUMBER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '39c95ad6-8271-4494-9702-03066abcc02b'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vectordirectorynumPKEYTran;
            END;
            ELSE BEGIN 
