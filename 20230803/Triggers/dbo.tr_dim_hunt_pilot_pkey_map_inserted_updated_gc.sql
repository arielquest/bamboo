...
GO
CREATE TRIGGER [dbo].[tr_dim_hunt_pilot_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_HUNT_PILOT_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_huntpiPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_HUNT_PILOT_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_HUNT_PILOT_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'af9964c7-68c8-42c3-9813-b9919cbb6874'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_huntpiPKEYTran;
            END;
            ELSE BEGIN 
