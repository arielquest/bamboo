...
GO
CREATE TRIGGER [dbo].[tr_dim_scl_search_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_SCL_SEARCH_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_sclseaPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SCL_SEARCH_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SCL_SEARCH_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'b2a289a1-f613-4d0d-8f57-f83e04521155'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_sclseaPKEYTran;
            END;
            ELSE BEGIN 
