...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_entity_type_mapping_inserted_gc] ON [dbo].[TB_CLU_RESOURCE_ENTITY_TYPE_MAPPING]
    FOR INSERT
AS
BEGIN 
    SET XACT_ABORT OFF; 
    ...
    WHERE   TABLE_NAME = 'TB_CLU_RESOURCE_ENTITY_TYPE_MAPPING';
