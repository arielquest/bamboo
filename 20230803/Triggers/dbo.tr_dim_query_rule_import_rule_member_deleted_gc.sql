...
GO
CREATE TRIGGER [dbo].[tr_dim_query_rule_import_rule_member_deleted_gc] ON [dbo].[TB_DIM_QUERY_RULE_IMPORT_RULE_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_QUERY_RULE_IMPORT_RULE_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_QUERY_RULE_IMPORT_RULE_MEMBER_GC AS datagc
