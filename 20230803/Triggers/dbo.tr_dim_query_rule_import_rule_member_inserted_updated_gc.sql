...
GO
CREATE TRIGGER [dbo].[tr_dim_query_rule_import_rule_member_inserted_updated_gc] ON [dbo].[TB_DIM_QUERY_RULE_IMPORT_RULE_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_queryruleimportrulememTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_QUERY_RULE_IMPORT_RULE_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_QUERY_RULE_IMPORT_RULE_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_queryruleimportrulememTran;
            END;
            ELSE BEGIN 
