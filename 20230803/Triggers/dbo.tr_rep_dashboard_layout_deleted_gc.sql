...
GO
CREATE TRIGGER [dbo].[tr_rep_dashboard_layout_deleted_gc] ON [dbo].[TB_REP_DASHBOARD_LAYOUT] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.DASHBOARD_LAYOUT_ID = datagc.GUID_KEY
