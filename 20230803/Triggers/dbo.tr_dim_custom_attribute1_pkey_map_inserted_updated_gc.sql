...
GO
CREATE TRIGGER [dbo].[tr_dim_custom_attribute1_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_CUSTOM_ATTRIBUTE1_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_CUSTOM_ATTRIBUTE1_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_CUSTOM_ATTRIBUTE1_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'f3f53a92-07f5-478f-b357-313fc4aebbdf'
