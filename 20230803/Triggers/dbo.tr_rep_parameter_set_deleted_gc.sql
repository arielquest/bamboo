...
GO
CREATE TRIGGER [dbo].[tr_rep_parameter_set_deleted_gc] ON [dbo].[TB_REP_PARAMETER_SET] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.PARAMETER_SET_ID = datagc.GUID_KEY
