...
GO
CREATE TRIGGER [dbo].[tr_dim_physical_interface_controller_pkey_map_inserted] ON [dbo].[TB_DIM_PHYSICAL_INTERFACE_CONTROLLER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
