...
GO
CREATE TRIGGER [dbo].[tr_dim_query_rule_campaign_member_pkey_map_inserted] ON [dbo].[TB_DIM_QUERY_RULE_CAMPAIGN_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
