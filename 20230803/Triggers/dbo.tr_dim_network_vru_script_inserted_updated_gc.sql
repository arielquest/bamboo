...
GO
CREATE TRIGGER [dbo].[tr_dim_network_vru_script_inserted_updated_gc] ON [dbo].[TB_DIM_NETWORK_VRU_SCRIPT] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_NETWORK_VRU_SCRIPT_GC dgc
