...
GO
CREATE TRIGGER [dbo].[tr_dim_cobrowse_page_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_COBROWSE_PAGE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_cobrowsepPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_COBROWSE_PAGE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_COBROWSE_PAGE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '516ff4e5-cbb6-4745-ad0f-a926ee0ad23e'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_cobrowsepPKEYTran;
            END;
            ELSE BEGIN 
