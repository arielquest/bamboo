...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_media_routing_domain_member_pkey_map_inserted] ON [dbo].[TB_DIM_PRECISION_QUEUE_MEDIA_ROUTING_DOMAIN_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
