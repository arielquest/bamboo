...
GO
CREATE TRIGGER [dbo].[tr_dim_media_routing_domain_inserted_updated_gc] ON [dbo].[TB_DIM_MEDIA_ROUTING_DOMAIN] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_MEDIA_ROUTING_DOMAIN_GC dgc
