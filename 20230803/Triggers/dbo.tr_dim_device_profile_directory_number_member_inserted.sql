...
GO
CREATE TRIGGER [dbo].[tr_dim_device_profile_directory_number_member_inserted] ON [dbo].[TB_DIM_DEVICE_PROFILE_DIRECTORY_NUMBER_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
