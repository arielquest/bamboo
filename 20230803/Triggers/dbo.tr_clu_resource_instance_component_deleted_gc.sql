...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_instance_component_deleted_gc] ON [dbo].[TB_CLU_RESOURCE_INSTANCE_COMPONENT] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.COMPONENT_ID = datagc.GUID_KEY
