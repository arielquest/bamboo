...
GO
CREATE   TRIGGER [dbo].[tr_dim_channel_address_deleted_gc]
    ON [dbo].[TB_DIM_CHANNEL_ADDRESS] FOR DELETE
AS
BEGIN
    SET XACT_ABORT OFF;
    SET NOCOUNT ON
    ...
    BEGIN TRANSACTION
        ...
        SELECT @TableGenerationCount = GENERATION_COUNT, @TableGenerationCountUrn =  TABLE_GENERATION_COUNT_URN FROM dbo.TS_ADM_TABLE_GENERATION_COUNT WITH (UPDLOCK) WHERE TABLE_NAME = 'TB_DIM_CHANNEL_ADDRESS'
