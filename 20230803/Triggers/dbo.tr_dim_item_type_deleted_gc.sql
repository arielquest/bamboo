...
GO
CREATE TRIGGER [dbo].[tr_dim_item_type_deleted_gc] ON [dbo].[TE_DIM_ITEM_TYPE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    WHERE TABLE_NAME = 'TE_DIM_ITEM_TYPE';
    ...
    INNER JOIN deleted AS d ON d.ITEM_TYPE_ID = datagc.GUID_KEY
