...
GO
CREATE TRIGGER [dbo].[tr_dim_service_peripheral_member_pkey_map_inserted] ON [dbo].[TB_DIM_SERVICE_PERIPHERAL_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
