...
GO
CREATE TRIGGER [dbo].[tr_dim_route_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ROUTE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_roPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_ROUTE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_ROUTE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '00005400-1000-0000-0000-000000000010'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_roPKEYTran;
            END;
            ELSE BEGIN 
