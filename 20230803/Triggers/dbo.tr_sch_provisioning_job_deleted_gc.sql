...
GO
CREATE TRIGGER [dbo].[tr_sch_provisioning_job_deleted_gc] ON [dbo].[TB_SCH_PROVISIONING_JOB] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC dbo.ap_adm01_increment_table_generation_count @TableName = 'TB_SCH_PROVISIONING_JOB', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT, @TableGenerationCountUrn = @TableGenerationCountUrn OUTPUT;
