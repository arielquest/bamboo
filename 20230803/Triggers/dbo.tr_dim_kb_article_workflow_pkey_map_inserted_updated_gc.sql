...
GO
CREATE TRIGGER [dbo].[tr_dim_kb_article_workflow_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_kbarticleworkfPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_KB_ARTICLE_WORKFLOW_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '140ae2b9-c3ba-42bb-8508-0240e45b95c1'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_kbarticleworkfPKEYTran;
            END;
            ELSE BEGIN 
