...
GO
CREATE TRIGGER [dbo].[tr_dim_notify_message_type_inserted_updated_gc] ON [dbo].[TB_DIM_NOTIFY_MESSAGE_TYPE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_NOTIFY_MESSAGE_TYPE_GC dgc
