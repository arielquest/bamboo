...
GO
CREATE TRIGGER [dbo].[tr_dim_routing_profile_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_ROUTING_PROFILE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_routingprofPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_ROUTING_PROFILE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_ROUTING_PROFILE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '1122ca7e-928b-4710-9af0-082b915fd495'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_routingprofPKEYTran;
            END;
            ELSE BEGIN 
