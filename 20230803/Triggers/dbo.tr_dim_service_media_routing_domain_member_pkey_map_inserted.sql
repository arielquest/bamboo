...
GO
CREATE TRIGGER [dbo].[tr_dim_service_media_routing_domain_member_pkey_map_inserted] ON [dbo].[TB_DIM_SERVICE_MEDIA_ROUTING_DOMAIN_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
