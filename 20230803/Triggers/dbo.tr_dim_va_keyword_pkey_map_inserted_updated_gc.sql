...
GO
CREATE TRIGGER [dbo].[tr_dim_va_keyword_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VA_KEYWORD_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vakeywPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VA_KEYWORD_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VA_KEYWORD_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'd1901408-b687-4d03-88fa-02d542c04dc8'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vakeywPKEYTran;
            END;
            ELSE BEGIN 
