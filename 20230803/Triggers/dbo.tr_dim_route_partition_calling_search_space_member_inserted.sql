...
GO
CREATE TRIGGER [dbo].[tr_dim_route_partition_calling_search_space_member_inserted] ON [dbo].[TB_DIM_ROUTE_PARTITION_CALLING_SEARCH_SPACE_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
