...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_routing_target_ivr_script_member_inserted] ON [dbo].[TB_DIM_IVR_ROUTING_TARGET_IVR_SCRIPT_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
