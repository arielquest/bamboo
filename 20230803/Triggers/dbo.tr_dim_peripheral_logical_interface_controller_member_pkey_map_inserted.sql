...
GO
CREATE TRIGGER [dbo].[tr_dim_peripheral_logical_interface_controller_member_pkey_map_inserted] ON [dbo].[TB_DIM_PERIPHERAL_LOGICAL_INTERFACE_CONTROLLER_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
