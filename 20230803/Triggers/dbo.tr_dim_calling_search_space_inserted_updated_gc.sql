...
GO
CREATE TRIGGER [dbo].[tr_dim_calling_search_space_inserted_updated_gc] ON [dbo].[TB_DIM_CALLING_SEARCH_SPACE] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_CALLING_SEARCH_SPACE_GC dgc
