...
GO
CREATE TRIGGER [dbo].[tr_dim_fiscal_quarter_deleted_gc] ON [dbo].[TB_DIM_FISCAL_QUARTER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.FISCAL_QUARTER_URN = datagc.INT_KEY
