...
GO
CREATE TRIGGER [dbo].[tr_dim_device_pool_call_manager_group_member_pkey_map_inserted] ON [dbo].[TB_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
