...
GO
CREATE TRIGGER [dbo].[tr_dim_user_group_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_USER_GROUP_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_usergrPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_USER_GROUP_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_USER_GROUP_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'c95a5f46-9dec-4cf3-80bc-f6943f3cf0c0'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_usergrPKEYTran;
            END;
            ELSE BEGIN 
