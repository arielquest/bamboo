...
GO
CREATE TRIGGER [dbo].[tr_rep_report_model_deleted_gc] ON [dbo].[TB_REP_REPORT_MODEL] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.REPORT_MODEL_ID = datagc.GUID_KEY
