...
GO
CREATE TRIGGER [dbo].[tr_dim_device_pool_call_manager_group_member_deleted_gc] ON [dbo].[TB_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            UPDATE dbo.TS_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_GC
            SET LAST_OPERATION = 'D', GENERATION_COUNT = @NewTableGenerationCount
            FROM dbo.TS_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_GC AS datagc
