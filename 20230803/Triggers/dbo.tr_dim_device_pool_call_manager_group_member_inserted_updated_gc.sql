...
GO
CREATE TRIGGER [dbo].[tr_dim_device_pool_call_manager_group_member_inserted_updated_gc] ON [dbo].[TB_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_devicepoolcallmanagergTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_DEVICE_POOL_CALL_MANAGER_GROUP_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_devicepoolcallmanagergTran;
            END;
            ELSE BEGIN 
