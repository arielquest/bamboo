...
GO
CREATE TRIGGER [dbo].[tr_dim_uc_service_profile_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_UC_SERVICE_PROFILE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ucserviceprofPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_UC_SERVICE_PROFILE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_UC_SERVICE_PROFILE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'c79483bb-ad3d-4135-83ce-bb3cf92bb765'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ucserviceprofPKEYTran;
            END;
            ELSE BEGIN 
