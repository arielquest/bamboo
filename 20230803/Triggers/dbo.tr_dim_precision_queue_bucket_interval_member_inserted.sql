...
GO
CREATE TRIGGER [dbo].[tr_dim_precision_queue_bucket_interval_member_inserted] ON [dbo].[TB_DIM_PRECISION_QUEUE_BUCKET_INTERVAL_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
