...
GO
CREATE TRIGGER [dbo].[tr_dim_agent_desktop_dialed_number_member_inserted] ON [dbo].[TB_DIM_AGENT_DESKTOP_DIALED_NUMBER_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
