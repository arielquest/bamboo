...
GO
CREATE TRIGGER [dbo].[tr_dim_route_enterprise_route_member_pkey_map_inserted] ON [dbo].[TB_DIM_ROUTE_ENTERPRISE_ROUTE_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
