...
GO
CREATE TRIGGER [dbo].[tr_adm_custom_attribute_localization_deleted_gc] ON [dbo].[TB_ADM_CUSTOM_ATTRIBUTE_LOCALIZATION] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    @NewTableGenerationCount BIGINT, @TableGenerationCountUrn INT, @deadlockRetry TINYINT = 0, @waitDelay CHAR(9);
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            INNER JOIN deleted AS d ON d.CUSTOM_ATTRIBUTE_LOCALIZATION_URN = datagc.INT_KEY
