...
GO
CREATE TRIGGER [dbo].[tr_sec_user_pkey_map_inserted_updated_gc] ON [dbo].[TB_SEC_USER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        SAVE TRANSACTION deadlockSavePoint;
            ...
            EXEC dbo.ap_adm01_increment_table_generation_count @TableName = 'TB_SEC_USER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT, @TableGenerationCountUrn = @TableGenerationCountUrn OUTPUT;
            ...
            ON (dgc.INT_KEY = correctValues.PKEY_MAP_URN AND dgc.TABLE_GENERATION_COUNT_URN = @TableGenerationCountUrn)
            WHEN MATCHED THEN
            ...
            WHEN NOT MATCHED THEN 
                ...
                VALUES (@TableGenerationCountUrn, correctValues.PKEY_MAP_URN, @NewTableGenerationCount, correctValues.LAST_OPERATION);
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'EEE2E0E2-C672-4f3c-A84F-59800D8565E4'
