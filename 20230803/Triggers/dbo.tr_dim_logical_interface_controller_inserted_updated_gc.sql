...
GO
CREATE TRIGGER [dbo].[tr_dim_logical_interface_controller_inserted_updated_gc] ON [dbo].[TB_DIM_LOGICAL_INTERFACE_CONTROLLER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            MERGE INTO dbo.TS_DIM_LOGICAL_INTERFACE_CONTROLLER_GC dgc
