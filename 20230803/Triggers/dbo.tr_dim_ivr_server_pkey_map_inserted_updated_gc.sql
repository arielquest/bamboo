...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_server_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_SERVER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ivrserPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IVR_SERVER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IVR_SERVER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '6368bd5b-e59d-4c8f-875b-82a117e8b7fc'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ivrserPKEYTran;
            END;
            ELSE BEGIN 
