...
GO
CREATE TRIGGER [dbo].[tr_dim_ghe_question_ghe_answer_member_inserted_updated_gc] ON [dbo].[TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ghequestiongheanswermeTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_GHE_QUESTION_GHE_ANSWER_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ghequestiongheanswermeTran;
            END;
            ELSE BEGIN 
