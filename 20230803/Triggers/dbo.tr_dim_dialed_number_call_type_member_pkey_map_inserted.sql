...
GO
CREATE TRIGGER [dbo].[tr_dim_dialed_number_call_type_member_pkey_map_inserted] ON [dbo].[TB_DIM_DIALED_NUMBER_CALL_TYPE_MEMBER_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
