...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_routing_target_ivr_script_member_inserted_updated_gc] ON [dbo].[TB_DIM_IVR_ROUTING_TARGET_IVR_SCRIPT_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_ivrroutingtargetivrscrTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_IVR_ROUTING_TARGET_IVR_SCRIPT_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_IVR_ROUTING_TARGET_IVR_SCRIPT_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_ivrroutingtargetivrscrTran;
            END;
            ELSE BEGIN 
