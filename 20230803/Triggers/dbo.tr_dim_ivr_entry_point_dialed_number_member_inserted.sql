...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_entry_point_dialed_number_member_inserted] ON [dbo].[TB_DIM_IVR_ENTRY_POINT_DIALED_NUMBER_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
