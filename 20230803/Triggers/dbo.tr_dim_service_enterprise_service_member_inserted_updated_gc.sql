...
GO
CREATE TRIGGER [dbo].[tr_dim_service_enterprise_service_member_inserted_updated_gc] ON [dbo].[TB_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_serviceenterpriseserviTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_SERVICE_ENTERPRISE_SERVICE_MEMBER_GC dgc
            ...
            BEGIN 
               COMMIT TRANSACTION TR_serviceenterpriseserviTran;
            END;
            ELSE BEGIN 
