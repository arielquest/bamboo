...
GO
CREATE TRIGGER [dbo].[tr_dim_vxmlapplication_server_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_VXMLAPPLICATION_SERVER_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_vxmlapplicationserPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_VXMLAPPLICATION_SERVER_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_VXMLAPPLICATION_SERVER_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = 'e8df41b0-854c-421d-9c6d-1eaa8fdc9dce'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_vxmlapplicationserPKEYTran;
            END;
            ELSE BEGIN 
