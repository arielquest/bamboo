...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_script_node_ivr_module_member_inserted] ON [dbo].[TB_DIM_IVR_SCRIPT_NODE_IVR_MODULE_MEMBER] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
