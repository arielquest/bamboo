...
GO
CREATE TRIGGER [dbo].[tr_dim_machine_resource_pkey_map_inserted_updated_gc] ON [dbo].[TB_DIM_MACHINE_RESOURCE_PKEY_MAP] FOR INSERT, UPDATE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    BEGIN TRANSACTION TR_machineresouPKEYTran;
    ...
    BEGIN 
        ...
        BEGIN TRY;
            ...
            EXEC [dbo].[ap_adm01_increment_table_generation_count] @TableName = 'TB_DIM_MACHINE_RESOURCE_PKEY_MAP', @NewTableGenerationCount = @NewTableGenerationCount OUTPUT;

            -- Update Data Generation Counts
            MERGE INTO dbo.TS_DIM_MACHINE_RESOURCE_PKEY_MAP_GC dgc
            ...
            BEGIN 
                ...
                AND TS_ADM_PROVISIONING_GENERATION_COUNT.ITEM_TYPE_ID = '780dad0d-aac3-4fba-8d10-8664e254e088'
            ...
            BEGIN 
               COMMIT TRANSACTION TR_machineresouPKEYTran;
            END;
            ELSE BEGIN 
