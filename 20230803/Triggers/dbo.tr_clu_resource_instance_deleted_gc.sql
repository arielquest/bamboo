...
GO
CREATE TRIGGER [dbo].[tr_clu_resource_instance_deleted_gc] ON [dbo].[TB_CLU_RESOURCE_INSTANCE] FOR DELETE AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
    ...
    INNER JOIN deleted AS d ON d.RESOURCE_INSTANCE_ID = datagc.GUID_KEY
