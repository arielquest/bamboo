...
GO
CREATE TRIGGER [dbo].[tr_dim_ivr_script_node_exit_state_pkey_map_inserted] ON [dbo].[TB_DIM_IVR_SCRIPT_NODE_EXIT_STATE_PKEY_MAP] FOR INSERT NOT FOR REPLICATION AS
BEGIN 
    SET XACT_ABORT OFF;
    SET NOCOUNT ON;
