...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_network_vru_script_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_networkvruscriPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [VRU_SCRIPT_NAME], [INTERRUPTIBLE], [OVERRIDABLE], [CONFIG_PARAM], [TIMEOUT],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_network_vru_script_pkey_map]
	TO [portalapp_role]
GO
