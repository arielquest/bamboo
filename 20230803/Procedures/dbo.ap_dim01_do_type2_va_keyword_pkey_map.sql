...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_va_keyword_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_vakePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_vakePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_va_keyword_pkey_map]
	TO [portalapp_role]
GO
