...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_custom_attribute2]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_customattributeTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_CUSTOM_ATTRIBUTE2
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 134, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_add_custom_attribute2]
	TO [portalapp_role]
GO
