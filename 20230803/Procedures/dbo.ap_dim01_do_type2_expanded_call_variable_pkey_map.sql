...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_expanded_call_variable_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_expandedcallvaPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [ECC_ARRAY], [VARIABLE_ENABLED], [GEOTEL_PROVIDED], [MAXIMUM_ARRAY_SIZE], [MAXIMUM_LENGTH], [PERSISTENT],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_expanded_call_variable_pkey_map]
	TO [portalapp_role]
GO
