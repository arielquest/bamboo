...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_media_routing_domain_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_mediaroutingdoPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [INTERRUPTIBLE], [MAX_CALLS_IN_QUEUE], [MAX_CALLS_IN_QUEUE_PER_CALLTYPE], [MAX_TASK_DURATION], [MAX_TIME_INQUEUE], [SERVICE_LEVEL_THRESHOLD],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_media_routing_domain_pkey_map]
	TO [portalapp_role]
GO
