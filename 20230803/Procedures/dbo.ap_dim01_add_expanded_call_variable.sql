...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_expanded_call_variable]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_expandedcallvarTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_EXPANDED_CALL_VARIABLE
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 43, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_add_expanded_call_variable]
	TO [portalapp_role]
GO
