...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_query_rule_campaign_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        FROM dbo.TB_DIM_QUERY_RULE_CAMPAIGN_MEMBER_PKEY_MAP 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_queryrulecampaPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            SELECT [PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], [STATUS], 
                            [QUERY_RULE_ENABLED], [QUERY_RULE_ORDER], [START_HOURS], [START_MINUTES], [END_HOURS], [END_MINUTES], [DURATION_ENABLED], [DURATION], [HIT_RATE_ENABLED], [HIT_RATE], [PENETRATION_ENABLED], [PENETRATION],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                            ...
                            INSERT INTO dbo.TB_DIM_QUERY_RULE_CAMPAIGN_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                            [QUERY_RULE_ENABLED], [QUERY_RULE_ORDER], [START_HOURS], [START_MINUTES], [END_HOURS], [END_MINUTES], [DURATION_ENABLED], [DURATION], [HIT_RATE_ENABLED], [HIT_RATE], [PENETRATION_ENABLED], [PENETRATION],                             [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                            [PURGED], [SYSTEM], [LATEST], [SOURCE_CHANGE_STAMP], [XML_DATA], [CUSTOM_XML_DATA])
                            SELECT [PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                            [QUERY_RULE_ENABLED], [QUERY_RULE_ORDER], [START_HOURS], [START_MINUTES], [END_HOURS], [END_MINUTES], [DURATION_ENABLED], [DURATION], [HIT_RATE_ENABLED], [HIT_RATE], [PENETRATION_ENABLED], [PENETRATION],                             [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                            [PURGED], [SYSTEM], [LATEST], [SOURCE_CHANGE_STAMP], [XML_DATA], [CUSTOM_XML_DATA]
                            FROM #PKEY_MAP_ROW;
                            ...
                            BEGIN 
                                SET @ReturnCode = -2;
                                RAISERROR ('Error updating membership: PkeyMapUrn [%d] Error [%d] Message [Concurrency conflict raised in TRY block.]', 16, 1, @PkeyMapUrn, @ReturnCode);
                            END;
                            ...
                            BEGIN 
                                ...
                                BEGIN 
                                    SET @ReturnCode = -1;
                                    RAISERROR ('Error updating membership: PkeyMapUrn [%d] Error [%d] Message [Effective surrogate exists raised in TRY block.]', 16, 1, @PkeyMapUrn, @ReturnCode);
                                END;
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_queryrulecampaPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_query_rule_campaign_member_pkey_map]
	TO [portalapp_role]
GO
