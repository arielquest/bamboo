...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_custom_attribute6_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_customattributPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_customattributPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_custom_attribute6_pkey_map]
	TO [portalapp_role]
GO
