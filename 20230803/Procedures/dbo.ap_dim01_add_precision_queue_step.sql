...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_precision_queue_step]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_precisionqueuesTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_PRECISION_QUEUE_STEP
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 79, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_add_precision_queue_step]
	TO [portalapp_role]
GO
