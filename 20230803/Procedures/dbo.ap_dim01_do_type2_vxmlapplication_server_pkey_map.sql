...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_vxmlapplication_server_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_vxmlapplicatioPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_vxmlapplicatioPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_vxmlapplication_server_pkey_map]
	TO [portalapp_role]
GO
