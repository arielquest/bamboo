...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_ivr_script_node_exit_state_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_ivrscriptnodeePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_ivrscriptnodeePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_ivr_script_node_exit_state_pkey_map]
	TO [portalapp_role]
GO
