...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_route_partition_calling_search_space_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        FROM dbo.TB_DIM_ROUTE_PARTITION_CALLING_SEARCH_SPACE_MEMBER_PKEY_MAP 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_routepartitionPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            [SEQUENCE],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                            ...
                            INSERT INTO dbo.TB_DIM_ROUTE_PARTITION_CALLING_SEARCH_SPACE_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                            [SEQUENCE],                             [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_routepartitionPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_route_partition_calling_search_space_member_pkey_map]
	TO [portalapp_role]
GO
