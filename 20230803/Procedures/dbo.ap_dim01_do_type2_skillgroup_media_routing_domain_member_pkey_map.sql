...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_skillgroup_media_routing_domain_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_skillgroupmediPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            INSERT INTO dbo.TB_DIM_SKILLGROUP_MEDIA_ROUTING_DOMAIN_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_skillgroupmediPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_skillgroup_media_routing_domain_member_pkey_map]
	TO [portalapp_role]
GO
