...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_custom_attribute5]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_customattributeTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_CUSTOM_ATTRIBUTE5
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 137, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_add_custom_attribute5]
	TO [portalapp_role]
GO
