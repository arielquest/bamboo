...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_person_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_pPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [DESCRIPTION], [FIRST_NAME], [LAST_NAME], [LOGIN_NAME], [PASS_PHRASE], [PASS_PHRASE_SHA], [LOGIN_ENABLED], [SSO_ENABLED], [VERIFICATION_STATUS], [HOME_CLUSTER], [ENABLE_USER], [MEETING_INFORMATION], [UC_SERVICE_PROFILE_BIZ_URN],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_pPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_person_pkey_map]
	TO [portalapp_role]
GO
