...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_tli]
(
            ...
            BEGIN TRANSACTION PADTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 99, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
