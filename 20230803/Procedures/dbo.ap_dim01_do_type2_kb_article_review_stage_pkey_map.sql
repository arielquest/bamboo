...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_kb_article_review_stage_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_kbarticlereviePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_kbarticlereviePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_kb_article_review_stage_pkey_map]
	TO [portalapp_role]
GO
