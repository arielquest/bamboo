...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_ivr_script_node_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_ivrscripPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [SPEECH_RECOGNITION], [DEFLECTION_POINT], [DEFLECTION_CATEGORY], [DEFLECTION_EXCEPTION],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_ivrscripPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_ivr_script_node_pkey_map]
	TO [portalapp_role]
GO
