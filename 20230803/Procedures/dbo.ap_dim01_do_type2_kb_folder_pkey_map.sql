...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_kb_folder_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_kbfPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_kbfPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_kb_folder_pkey_map]
	TO [portalapp_role]
GO
