...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_precision_queue_step_precision_queue_member_pkey_map]
(
                 ...
                 BEGIN TRANSACTION PTYP_precisionqueuePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            INSERT INTO dbo.TB_DIM_PRECISION_QUEUE_STEP_PRECISION_QUEUE_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_precision_queue_step_precision_queue_member_pkey_map]
	TO [portalapp_role]
GO
