...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_skillgroup_campaign_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        FROM dbo.TB_DIM_SKILLGROUP_CAMPAIGN_MEMBER_PKEY_MAP 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_skillgroupcampPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            [ABANDONED_ROUTE_POINT], [AUTO_ANSWER_RESERVATION_CALL], [CONFIG_PARAM], [DIGITS], [IVR_PORTS], [IVR_ROUTE_POINT], [OVERFLOW_AGENTS], [RECORDS_TO_CACHE], [RESERVATION_PERCENTAGE],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                            ...
                            INSERT INTO dbo.TB_DIM_SKILLGROUP_CAMPAIGN_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                            [ABANDONED_ROUTE_POINT], [AUTO_ANSWER_RESERVATION_CALL], [CONFIG_PARAM], [DIGITS], [IVR_PORTS], [IVR_ROUTE_POINT], [OVERFLOW_AGENTS], [RECORDS_TO_CACHE], [RESERVATION_PERCENTAGE],                             [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_skillgroupcampPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_skillgroup_campaign_member_pkey_map]
	TO [portalapp_role]
GO
