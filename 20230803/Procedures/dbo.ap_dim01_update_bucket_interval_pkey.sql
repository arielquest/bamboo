...
GO
CREATE PROCEDURE [dbo].[ap_dim01_update_bucket_interval_pkey]
(    
        ...
        ELSE BEGIN 
            ...
            ELSE BEGIN 
                ...
                BEGIN 
                    ...
                    RAISERROR('ap_dim01_update_bucket_interval_pkey: Cannot force status change on non provisionable update', 16, 1) WITH LOG
                END;
                ELSE BEGIN 
                    ...
                    BEGIN 
                        ...
                        SET @ItemTypeId = '00008400-1000-0000-0000-000000000010';
                        ...
                        SELECT  @OldEffectiveFrom = map.[EFFECTIVE_FROM],
                                ...
                                @OldIntervalUpperBound1 = map.[INTERVAL_UPPER_BOUND_1],
                                @OldIntervalUpperBound2 = map.[INTERVAL_UPPER_BOUND_2],
                                @OldIntervalUpperBound3 = map.[INTERVAL_UPPER_BOUND_3],
                                @OldIntervalUpperBound4 = map.[INTERVAL_UPPER_BOUND_4],
                                @OldIntervalUpperBound5 = map.[INTERVAL_UPPER_BOUND_5],
                                @OldIntervalUpperBound6 = map.[INTERVAL_UPPER_BOUND_6],
                                @OldIntervalUpperBound7 = map.[INTERVAL_UPPER_BOUND_7],
                                @OldIntervalUpperBound8 = map.[INTERVAL_UPPER_BOUND_8],
                                @OldIntervalUpperBound9 = map.[INTERVAL_UPPER_BOUND_9], 
                        ...
                        FROM dbo.TB_DIM_BUCKET_INTERVAL_PKEY_MAP AS map WITH(UPDLOCK)
                        INNER JOIN dbo.TB_DIM_BUCKET_INTERVAL AS item WITH(READUNCOMMITTED) ON map.ITEM_BIZ_URN = item.ITEM_BIZ_URN AND item.LATEST = 1
                        ...
                        BEGIN 
                            ...
                            FROM (SELECT 
                                  ...
                                  WHERE TABLE_NAME = 'TB_DIM_BUCKET_INTERVAL_PKEY_MAP' 
                        ...
                        INSERT INTO @AuditAttributeTable(ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                        SELECT 
                        'BUCKET_INTERVAL_' + CASE WHEN OldAttributes.Attribute IS NULL THEN NewAttributes.Attribute.value('string(@Name)', 'NVARCHAR(250)') ELSE OldAttributes.Attribute.value('string(@Name)', 'NVARCHAR(250)') END AS [ATTRIBUTE_FIELD],
                        ...
                        INSERT INTO @AuditAttributeTable(ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                        SELECT 
                        'custom.BUCKET_INTERVAL_'  + CASE WHEN OldAttributes.Attribute IS NULL THEN NewAttributes.Attribute.value('string(@Name)', 'NVARCHAR(250)') ELSE OldAttributes.Attribute.value('string(@Name)', 'NVARCHAR(250)') END AS [ATTRIBUTE_FIELD],        
                        SUBSTRING(CAST(NewAttributes.Attribute.query('text()') AS NVARCHAR(MAX)), 1, 500) AS [NEW_VALUE],
                        SUBSTRING(CAST(OldAttributes.Attribute.query('text()') AS NVARCHAR(MAX)), 1, 500) AS [OLD_VALUE]
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERNAL_NAME', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_DESCRIPTION', @AuditTempNew, @AuditTempOld);
                        ...
                        OR (@OldIntervalUpperBound1 IS NULL AND @IntervalUpperBound1 IS NOT NULL)
                        OR (@OldIntervalUpperBound1 IS NOT NULL AND @IntervalUpperBound1 IS NULL) 
                        BEGIN  
                            SET @AuditTempOld = CAST(@OldIntervalUpperBound1 AS NVARCHAR(250));
                            SET @AuditTempNew = CAST(@IntervalUpperBound1 AS NVARCHAR(250)); 

                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_1', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_2', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_3', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_4', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_5', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_6', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_7', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_8', @AuditTempNew, @AuditTempOld);
                        ...
                        BEGIN  
                            ...
                            INSERT INTO @AuditAttributeTable (ATTRIBUTE_FIELD, NEW_VALUE, OLD_VALUE)
                            VALUES('BUCKET_INTERVAL_INTERVAL_UPPER_BOUND_9', @AuditTempNew, @AuditTempOld);
                    ...
                    BEGIN 
                        ...
                        ELSE BEGIN      
                            ...
                            BEGIN TRANSACTION PUPD_bucketintPKEYTran;
                            BEGIN TRY;
                                -- Update the pkey record
                                UPDATE dbo.TB_DIM_BUCKET_INTERVAL_PKEY_MAP
                                ...
                                EXEC dbo.ap_adm01_audit_event @SessionId, @AuditTypeName, DEFAULT, @ItemBusinessUrn, NULL, 8, DEFAULT, @ClusterResourceId, NULL, 'S', 0, 'DIMENSION_UPDATED_ON_EQUIPMENT', NULL, @FieldChangeXmlData, NULL, @AuditUrn OUTPUT;
                                
                                IF @InitialTransactionCount = 0 
                                BEGIN 
                                    COMMIT TRANSACTION PUPD_bucketintPKEYTran;
                                END;
                                ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_update_bucket_interval_pkey]
	TO [portalapp_role]
GO
