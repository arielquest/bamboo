...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_routing_client_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_routingcPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [CLIENT_TYPE], [TIMEOUT_THRESHOLD], [TIMEOUT_LIMIT], [LATE_THRESHOLD], [DIALED_NUMBER_LABEL_MAP_PRESENT], [NETWORK_ROUTING_CLIENT], [NETWORK_TRANSFER_PREFERED],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_routingcPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_routing_client_pkey_map]
	TO [portalapp_role]
GO
