...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_precision_queue_step_precision_attribute_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        FROM dbo.TB_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER_PKEY_MAP 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_precisionqueuePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            [PARENTHESES_COUNT], [TERM_RELATION], [ATTRIBUTE_RELATION], [VALUE_1], [VALUE_2],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                            ...
                            INSERT INTO dbo.TB_DIM_PRECISION_QUEUE_STEP_PRECISION_ATTRIBUTE_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                            [PARENTHESES_COUNT], [TERM_RELATION], [ATTRIBUTE_RELATION], [VALUE_1], [VALUE_2],                             [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_precisionqueuePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_precision_queue_step_precision_attribute_member_pkey_map]
	TO [portalapp_role]
GO
