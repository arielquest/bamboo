...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_precision_queue_step_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_precisionqueuePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [DESCRIPTION], [STEP_ORDER], [WAIT_TIME], [CONSIDER_IF], [NEXT_STEP],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_precision_queue_step_pkey_map]
	TO [portalapp_role]
GO
