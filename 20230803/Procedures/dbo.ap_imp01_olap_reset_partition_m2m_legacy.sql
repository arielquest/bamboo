...
GO
CREATE PROCEDURE [dbo].[ap_imp01_olap_reset_partition_m2m_legacy] (@I_ParentObjectName VARCHAR(50), @I_ObjectName VARCHAR(128))
AS
...
BEGIN TRANSACTION ResetOlapTransactionM2M;
    ...
    BEGIN TRY;
        ...
        SELECT @v_Sql = 'INSERT INTO [dbo].[TS_IMP_SUMMARIZED]' + CHAR(13) + CHAR(10) +
                        ...
                        '[MEMBER_URN], ''I'', 0 FROM [dbo].[' + @v_PrimaryTable + ']; ';
        
        EXECUTE sp_executesql @v_Sql;

        IF @InitialTransactionCount = 0 
        BEGIN 
           COMMIT TRANSACTION ResetOlapTransactionM2M;
        END;
        ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_imp01_olap_reset_partition_m2m_legacy]
	TO [portalapp_role]
GO
