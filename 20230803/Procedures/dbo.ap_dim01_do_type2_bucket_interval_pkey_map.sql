...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_bucket_interval_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_bucketintPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [INTERVAL_UPPER_BOUND_1], [INTERVAL_UPPER_BOUND_2], [INTERVAL_UPPER_BOUND_3], [INTERVAL_UPPER_BOUND_4], [INTERVAL_UPPER_BOUND_5], [INTERVAL_UPPER_BOUND_6], [INTERVAL_UPPER_BOUND_7], [INTERVAL_UPPER_BOUND_8], [INTERVAL_UPPER_BOUND_9],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_bucketintPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_bucket_interval_pkey_map]
	TO [portalapp_role]
GO
