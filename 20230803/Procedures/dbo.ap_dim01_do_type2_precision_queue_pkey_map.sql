...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_precision_queue_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_precisionPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [AGENT_ORDERING], [CALL_ORDERING], [SERVICE_LEVEL_THRESHOLD], [SERVICE_LEVEL_TYPE], [FORCE_EXPANDING_QUEUE],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_precisionPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_precision_queue_pkey_map]
	TO [portalapp_role]
GO
