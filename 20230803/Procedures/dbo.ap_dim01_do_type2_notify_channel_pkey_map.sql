...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_notify_channel_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_notifychPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_notifychPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_notify_channel_pkey_map]
	TO [portalapp_role]
GO
