...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_port]
(
            ...
            BEGIN TRANSACTION PADDTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 76, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
