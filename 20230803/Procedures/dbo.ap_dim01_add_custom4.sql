...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_custom4]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_cuTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_CUSTOM4
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 24, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
