...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_service_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_sePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [PERIPHERAL_NUMBER], [PERIPHERAL_NAME], [PERIPHERAL_SERVICE_LEVEL_TYPE], [SERVICE_LEVEL_TYPE], [SERVICE_LEVEL_THRESHOLD], [EXTENSION], [USER_DELETABLE],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_sePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_service_pkey_map]
	TO [portalapp_role]
GO
