...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_precision_attribute_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_precisionattriPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [ATTRIBUTE_DATA_TYPE], [MINIMUM_VALUE], [MAXIMUM_VALUE], [DEFAULT_VALUE], [APPEARS_ON_DESKTOP], [SETTABLE_BY_AGENT],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_precisionattriPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_precision_attribute_pkey_map]
	TO [portalapp_role]
GO
