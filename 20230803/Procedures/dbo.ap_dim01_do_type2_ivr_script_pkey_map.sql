...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_ivr_script_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_ivrsPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [SCRIPT_NAME], [DESCRIPTION],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_ivr_script_pkey_map]
	TO [portalapp_role]
GO
