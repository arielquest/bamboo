...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_ghe_cluster_group_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_gheclustergrouPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_gheclustergrouPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_ghe_cluster_group_pkey_map]
	TO [portalapp_role]
GO
