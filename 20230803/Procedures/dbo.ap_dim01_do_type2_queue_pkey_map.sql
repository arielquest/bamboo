...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_queue_pkey_map]
(
                ...
                BEGIN TRANSACTION PTYP_PKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [INTERNAL_NAME], [DESCRIPTION], [STATE], [EMAIL_ROUTING_TYPE], [CHAT_ROUTING_TYPE], [SOCIAL_ROUTING_TYPE],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_queue_pkey_map]
	TO [portalapp_role]
GO
