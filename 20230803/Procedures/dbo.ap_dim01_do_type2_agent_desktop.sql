...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_agent_desktop]
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                ...
                BEGIN TRANSACTION PTYP_agentdeTran;
                    WHILE @deadlockRetry < 3
                    BEGIN 
                        SAVE TRANSACTION deadlockSavePoint;
                        BEGIN TRY;
                            -- Insert the new type-2 item record
                            INSERT INTO dbo.TB_DIM_AGENT_DESKTOP ([ITEM_BIZ_URN], [SKIP_LEVEL], [FOLDER_ID], [OWNER_ID], [ITEM_SUBTYPE_ID], [NAME], [DESCRIPTION],
[DEPARTMENT_BIZ_URN],
...
[DEPARTMENT_BIZ_URN],
                            ...
                            BEGIN            
                                ...
                                UPDATE dbo.TB_DIM_AGENT_DESKTOP 
...
[ACD_SHARED_LINE_USAGE], 
                                ...
                                INSERT INTO dbo.TB_DIM_AGENT_DESKTOP_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [ITEM_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2],                            
[INTERNAL_NAME], 
[DESCRIPTION], 
[AVAILABLE_AFTER_INCOMING], 
[AVAILABLE_AFTER_OUTGOING], 
...
[INTERNAL_NAME], [DESCRIPTION], [AVAILABLE_AFTER_INCOMING], [AVAILABLE_AFTER_OUTGOING], [WRAPUP_DATA_INCOMING_MODE], [WRAPUP_DATA_OUTGOING_MODE], [AUTO_ANSWER_ENABLED], [IDLE_REASON_REQUIRED], [LOGOUT_NON_ACTIVITY_TIME], [LOGOUT_REASON_REQUIRED], [SUPERVISOR_CALLS_ALLOWED], [SUPERVISOR_ASSIST_CALL_METHOD], [EMERGENCY_CALL_METHOD], [AUTO_RECORD_ON_EMERGENCY], [AGENT_TO_AGENT_CALLS_ALLOWED], [OUTBOUND_ACCESS_INTERNATIONAL], [OUTBOUND_ACCESS_PUBLIC_NETWORK], [OUTBOUND_ACCESS_PRIVATE_NETWORK], [OUTBOUND_ACCESS_OPERATOR_ASSISTED], [OUTBOUND_ACCESS_PBX], [NON_ACD_CALLS_ALLOWED], [QUALITY_RECORDING_RATE], [RECORDING_MODE], [WORK_MODE_TIMER], [RING_NO_ANSWER_TIME], [SILENT_MONITOR_WARNING_MESSAGE], [SILENT_MONITOR_AUDIBLE_INDICATION], [DEFAULT_DEVICE_PORT_ADDRESS], [AGENT_CAN_SELECT_GROUP], [REMOTE_AGENT_TYPE], [REMOTE_LOGIN_WITHOUT_DESKTOP], [PLAY_ZIP_TONE], [ACD_SHARED_LINE_USAGE],                                 [STATUS], [EFFECTIVE_FROM], [EFFECTIVE_TO], [CREATED_BY_ID], [MODIFIED_BY_ID], [MODIFIED_DATE], [CREATION_DATE],
                                [PURGED], [SYSTEM], [LATEST], [SOURCE_CHANGE_STAMP], [XML_DATA], [CUSTOM_XML_DATA]
                                FROM #PKEY_MAP_ROWS;
                           ...
                           BEGIN 
                               ...
                               VALUES('AT_DIMENSION_TYPE_2_PERFORMED', @ItemBusinessUrn, @NewItemUrn, 2, 'DIMENSION_TYPE_2_CHANGE');
                           END;
                           ELSE BEGIN 
                               INSERT INTO @AuditTable(AUDIT_TYPE_INTERNAL_NAME, INT_VAL_1, INT_VAL_2, INT_VAL_3, EVENT_DESCRIPTION)                
                               VALUES('AT_DIMENSION_TYPE_2_TOMBSTONE_PERFORMED', @ItemBusinessUrn, @ItemUrn, 2, 'DIMENSION_TYPE_2_CHANGE');
                           END;
            
                           IF @MaintainBusinessKey = 0
                           BEGIN 
                               INSERT INTO @AuditTable(AUDIT_TYPE_INTERNAL_NAME, INT_VAL_1, INT_VAL_2, INT_VAL_3, EVENT_DESCRIPTION)
                               VALUES('AT_DIMENSION_TYPE_2_REVIVAL_PERFORMED', @NewItemBusinessUrn, @ItemUrn, 2, 'DIMENSION_TYPE_2_CHANGE');
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_agentdeTran;
                           END;
                           ELSE BEGIN 
    ...
    ELSE BEGIN 
        ...
        BEGIN 
            ...
            END;
        END;
        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_TYPE_2_PERFORMED', DEFAULT, @ItemBusinessUrn, DEFAULT, 2, DEFAULT, DEFAULT, DEFAULT, 'F', 0, 'DIMENSION_TYPE_2_CHANGE', NULL, DEFAULT, DEFAULT, @AuditUrn out;
        RAISERROR(@ErrorMessage, 16, 1, @ReturnCode) WITH LOG;
    END;
    RETURN @ReturnCode;
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_agent_desktop]
	TO [portalapp_role]
GO
