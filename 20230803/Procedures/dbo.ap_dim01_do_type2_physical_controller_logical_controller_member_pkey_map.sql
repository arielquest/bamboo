...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_physical_controller_logical_controller_member_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                 BEGIN TRANSACTION PTYP_physicalcontroPKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;
                            ...
                            INSERT INTO dbo.TB_DIM_PHYSICAL_CONTROLLER_LOGICAL_CONTROLLER_MEMBER_PKEY_MAP  ([PKEY_MAP_BIZ_URN], [MEMBER_BIZ_URN], [CLUSTER_RESOURCE_ID], [PKEY1], [PKEY2], 
                           ...
                           BEGIN 
                              COMMIT TRANSACTION PTYP_physicalcontroPKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_physical_controller_logical_controller_member_pkey_map]
	TO [portalapp_role]
GO
