...
GO
CREATE PROCEDURE [dbo].[ap_dim01_do_type2_directory_number_pkey_map]
(
...
AS
    ...
    BEGIN 
        ...
        BEGIN 
            ...
            BEGIN 
                BEGIN TRANSACTION PTYP_directorynumbePKEYTran;
                    ...
                    BEGIN 
                        ...
                        BEGIN TRY;                     
                            ...
                            [DESCRIPTION], [DIRECTORY_NUMBER_OR_PATTERN], [IPCC_ENABLED],                             CASE WHEN [EFFECTIVE_FROM] > @EffectiveFrom THEN [EFFECTIVE_FROM] ELSE @EffectiveFrom END AS [EFFECTIVE_FROM],
                           ...
                           BEGIN 
                               COMMIT TRANSACTION PTYP_directorynumbePKEYTran;
                           END;
                           ELSE BEGIN 
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_do_type2_directory_number_pkey_map]
	TO [portalapp_role]
GO
