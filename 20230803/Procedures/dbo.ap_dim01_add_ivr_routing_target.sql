...
GO
CREATE PROCEDURE [dbo].[ap_dim01_add_ivr_routing_target]
(
        ...
        BEGIN
            ...
            BEGIN TRANSACTION PADD_ivrroutingtargeTran;
                ...
                BEGIN 
                    ...
                    BEGIN TRY;
                        -- Add the base data
                        INSERT INTO dbo.TB_DIM_IVR_ROUTING_TARGET
                        (
                        ...
                        -- Audit success
                        EXEC dbo.ap_adm01_audit_event @SessionId, 'AT_DIMENSION_INSERT_COMMITTED', DEFAULT, @ItemUrn, DEFAULT, 58, DEFAULT, DEFAULT, DEFAULT, 'S', 0, 'DIMENSION_ADDED', NULL, NULL, NULL, @AuditUrn OUTPUT;
...
GO
GRANT EXECUTE
	ON [dbo].[ap_dim01_add_ivr_routing_target]
	TO [portalapp_role]
GO
