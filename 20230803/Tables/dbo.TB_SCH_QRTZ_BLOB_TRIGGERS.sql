...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[TB_SCH_QRTZ_BLOB_TRIGGERS] (
		...
		CONSTRAINT [PK_TB_SCH_QRTZ_BLOB_TRIGGERS]
		PRIMARY KEY
		CLUSTERED
...
GRANT UPDATE
	...
	TO [portalapp_role]
GO
ALTER TABLE [dbo].[TB_SCH_QRTZ_BLOB_TRIGGERS] SET (LOCK_ESCALATION = TABLE)
GO
